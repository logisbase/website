export const contentAgentConfig = {
  ...
  topicIdeas: {
    ...
    examples: [
      ...
      'Comparing LogisBase with Onfleet for source-accessible last-mile delivery software',
  ...
  seedClusters: [
    ...
    'source-accessible delivery management software',
    'source-accessible last mile delivery software',
