...
All notable changes to the LogisBase marketing & docs site (logisbase.com) are documented here.
...
- Renamed the npm package from `plasma-nextjs-template` to `logisbase.com` and reset the version to `0.1.0`.
