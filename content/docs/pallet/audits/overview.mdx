...
1. Navigate to **Pallet** > **Audits** > **Cycle Counts** in the LogisBase Console.
...
4. Pallet generates a list of all Products that are _supposed_ to be in that area, along with their expected quantities.
