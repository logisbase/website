---
title: Storefront
description: Storefront is the headless e-commerce and marketplace extension for LogisBase — power on-demand delivery apps, multi-vendor marketplaces, and D2C platforms.
---

# Storefront

**Storefront** is the headless commerce and marketplace extension for LogisBase. It provides the complete backend infrastructure to build on-demand delivery apps, multi-vendor marketplaces, or direct-to-consumer e-commerce platforms — all deeply integrated with Fleet-Ops so orders flow automatically into your dispatch system.
...
| **Source-Accessible App** | A React Native + web client your customers download — see [Storefront App](/docs/storefront/app/overview) |
...
<div className="not-prose mt-6 grid grid-cols-1 gap-4 sm:grid-cols-3">
  <Card>
    ...
    <CardContent>
      <a
        href="/docs/storefront/getting-started/quickstart"
  ...
  <Card>
    ...
    <CardContent>
      <a
        href="/docs/storefront/getting-started/core-concepts"
        className="text-primary text-sm hover:underline"
      >
        Core Concepts →
      </a>
  ...
  <Card>
    <CardHeader>
      ...
      <CardDescription className="text-xs">
        Add products with variants, addons, and categories — the core of every
        store.
      </CardDescription>
    </CardHeader>
    <CardContent>
      <a
        href="/docs/storefront/catalog/products"
        className="text-primary text-sm hover:underline"
      >
        Products →
      </a>
...
<Callout type="info">
  Storefront comes pre-installed with every LogisBase instance — no separate
  installation is required. Navigate to **Storefront** in the console sidebar to
  begin.
</Callout>
