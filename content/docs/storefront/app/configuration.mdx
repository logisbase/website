...
| `FLEETBASE_HOST`      | Your LogisBase API base URL                                                                     |
| `FLEETBASE_KEY`       | LogisBase API secret key — Console → **Developers**                                             |
...
| Var                    | Default | Purpose                                      |
| :--------------------- | :------ | :------------------------------------------- |
| `FLEETBASE_HOST`       | —       | LogisBase API host                           |
| `FLEETBASE_KEY`        | —       | LogisBase API secret                         |
...
| `DEFAULT_SERVICE_AREA`     | —          | LogisBase Service Area `public_id` (e.g. `sa_xDPX9Dy`) — bounds the map |
