...
description: The Storefront App is the source-available React Native client your customers use to browse stores and place orders against your LogisBase Storefront backend.
---

# Storefront App

The **Storefront App** is the source-available customer-facing client for the Storefront extension. It is a single React Native codebase that targets **iOS, Android, and the web**, paired with the Storefront backend running on your LogisBase instance.

[github.com/logisbase/storefront-app](https://github.com/logisbase/storefront-app)
