...
| File                                                                   | Description                       |
| :--------------------------------------------------------------------- | :-------------------------------- |
| [`addon/components/schedule-calendar.hbs`](https://tally.so/r/obgQQx)  | Template                          |
| [`addon/components/schedule-calendar.js`](https://tally.so/r/obgQQx)   | Class                             |
| [`addon/components/schedule-item-card.hbs`](https://tally.so/r/obgQQx) | Item card template                |
| [`addon/components/schedule-item-card.js`](https://tally.so/r/obgQQx)  | Item card class                   |
| [`addon/components/event-calendar.hbs`](https://tally.so/r/obgQQx)     | Date-grid calendar template       |
| [`addon/components/event-calendar.js`](https://tally.so/r/obgQQx)      | Date-grid calendar class          |
| [`SCHEDULING_COMPONENTS.md`](https://tally.so/r/obgQQx)                | Reference doc in the package root |
