...
| File                                                       | Description   |
| :--------------------------------------------------------- | :------------ |
| [`addon/components/kanban.hbs`](https://tally.so/r/obgQQx) | Template      |
| [`addon/components/kanban.js`](https://tally.so/r/obgQQx)  | Class         |
| [`addon/components/kanban/`](https://tally.so/r/obgQQx)    | Subcomponents |
