...
| File                                                                                                         | Description   |
| :----------------------------------------------------------------------------------------------------------- | :------------ |
| [`addon/components/kanban.hbs`](https://github.com/logisbase/ember-ui/blob/main/addon/components/kanban.hbs) | Template      |
| [`addon/components/kanban.js`](https://github.com/logisbase/ember-ui/blob/main/addon/components/kanban.js)   | Class         |
| [`addon/components/kanban/`](https://github.com/logisbase/ember-ui/tree/main/addon/components/kanban)        | Subcomponents |
