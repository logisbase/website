...
| File                                                                 | Description                                                 |
| :------------------------------------------------------------------- | :---------------------------------------------------------- |
| [`addon/components/template-builder.hbs`](https://tally.so/r/obgQQx) | Template                                                    |
| [`addon/components/template-builder.js`](https://tally.so/r/obgQQx)  | Class — extensive JSDoc, start there for advanced extension |
| [`addon/components/template-builder/`](https://tally.so/r/obgQQx)    | Subcomponents                                               |
