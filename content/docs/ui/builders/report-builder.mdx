...
| File                                                                                                                         | Description |
| :--------------------------------------------------------------------------------------------------------------------------- | :---------- |
| [`addon/components/report-builder.hbs`](https://github.com/logisbase/ember-ui/blob/main/addon/components/report-builder.hbs) | Template    |
| [`addon/components/report-builder.js`](https://github.com/logisbase/ember-ui/blob/main/addon/components/report-builder.js)   | Class       |
