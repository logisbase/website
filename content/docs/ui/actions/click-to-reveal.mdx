...
<ClickToReveal
  @value={{this.webhook.signing_secret}}
  @buttonText='Reveal signing secret'
/>
...
| File                                                                                                                           | Description                     |
| :----------------------------------------------------------------------------------------------------------------------------- | :------------------------------ |
| [`addon/components/click-to-reveal.hbs`](https://github.com/logisbase/ember-ui/blob/main/addon/components/click-to-reveal.hbs) | Template                        |
| [`addon/components/click-to-reveal.js`](https://github.com/logisbase/ember-ui/blob/main/addon/components/click-to-reveal.js)   | Class (extends `click-to-copy`) |
