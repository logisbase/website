...
| File                                                                | Description                     |
| :------------------------------------------------------------------ | :------------------------------ |
| [`addon/components/click-to-reveal.hbs`](https://tally.so/r/obgQQx) | Template                        |
| [`addon/components/click-to-reveal.js`](https://tally.so/r/obgQQx)  | Class (extends `click-to-copy`) |
