...
| File                                                                                                         | Description |
| :----------------------------------------------------------------------------------------------------------- | :---------- |
| [`addon/components/button.hbs`](https://github.com/logisbase/ember-ui/blob/main/addon/components/button.hbs) | Template    |
| [`addon/components/button.js`](https://github.com/logisbase/ember-ui/blob/main/addon/components/button.js)   | Class       |
