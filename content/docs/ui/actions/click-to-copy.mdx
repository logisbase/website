...
| File                                                                                                                       | Description |
| :------------------------------------------------------------------------------------------------------------------------- | :---------- |
| [`addon/components/click-to-copy.hbs`](https://github.com/logisbase/ember-ui/blob/main/addon/components/click-to-copy.hbs) | Template    |
| [`addon/components/click-to-copy.js`](https://github.com/logisbase/ember-ui/blob/main/addon/components/click-to-copy.js)   | Class       |
