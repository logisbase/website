...
| File                                                                        | Description |
| :-------------------------------------------------------------------------- | :---------- |
| [`addon/helpers/can-action.js`](https://tally.so/r/obgQQx)                  | Helper      |
| [`addon/helpers/can-delete.js`](https://tally.so/r/obgQQx)                  | Helper      |
| [`addon/helpers/can-write.js`](https://tally.so/r/obgQQx)                   | Helper      |
| [`addon/helpers/cannot-action.js`](https://tally.so/r/obgQQx)               | Helper      |
| [`addon/helpers/cannot-delete.js`](https://tally.so/r/obgQQx)               | Helper      |
| [`addon/helpers/cannot-write.js`](https://tally.so/r/obgQQx)                | Helper      |
| [`addon/helpers/get-write-permission.js`](https://tally.so/r/obgQQx)        | Helper      |
| [`addon/helpers/can-remove-chat-participant.js`](https://tally.so/r/obgQQx) | Helper      |
