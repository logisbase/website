...
| File                                                                                                                  | Description       |
| :-------------------------------------------------------------------------------------------------------------------- | :---------------- |
| [`addon/services/sidebar.js`](https://github.com/logisbase/ember-ui/blob/main/addon/services/sidebar.js)              | Service class     |
| [`addon/components/layout/sidebar/`](https://github.com/logisbase/ember-ui/tree/main/addon/components/layout/sidebar) | Sidebar component |
