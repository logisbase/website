...
| File                                                                       | Description        |
| :------------------------------------------------------------------------- | :----------------- |
| [`addon/services/resource-context-panel.js`](https://tally.so/r/obgQQx)    | Service class      |
| [`addon/components/resource-context-panel.hbs`](https://tally.so/r/obgQQx) | Component template |
| [`addon/components/resource-context-panel.js`](https://tally.so/r/obgQQx)  | Component class    |
