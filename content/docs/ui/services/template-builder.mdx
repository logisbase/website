...
description: 'The `template-builder` service lets extensions register LogisBase model classes as queryable resource types in the TemplateQuery form.'
---
...
export function initialize(appInstance) {
  ...
  templateBuilder.registerResourceTypes([
    {
      label: 'Order',
      value: 'LogisBase\\FleetOps\\Models\\Order',
      icon: 'route',
    },
    {
      label: 'Driver',
      value: 'LogisBase\\FleetOps\\Models\\Driver',
      icon: 'id-card',
    },
    {
      label: 'Vehicle',
      value: 'LogisBase\\FleetOps\\Models\\Vehicle',
      icon: 'truck',
    },
  ]);
}
...
export function initialize(appInstance) {
  ...
  templateBuilder.registerResourceTypes([
    ...
    {
      label: 'Place',
      value: 'LogisBase\\FleetOps\\Models\\Place',
      icon: 'location-dot',
    },
    {
      label: 'Service Rate',
      value: 'LogisBase\\FleetOps\\Models\\ServiceRate',
      icon: 'dollar-sign',
    },
  ]);
}
...
| File                                                                                                                       | Description   |
| :------------------------------------------------------------------------------------------------------------------------- | :------------ |
| [`addon/services/template-builder.js`](https://github.com/logisbase/ember-ui/blob/main/addon/services/template-builder.js) | Service class |
