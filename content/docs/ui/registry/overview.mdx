...
| :-------------- | :--------------------------------------------------------------------------------- | :-------------------------------------------------------------- |
| Customer Portal | Hooks, registries, login menu item, settings menu item                             | [customer-portal/addon/extension.js](https://tally.so/r/obgQQx) |
| Storefront      | Header menu item with shortcuts, dashboard widgets                                 | [storefront/addon/extension.js](https://tally.so/r/obgQQx)      |
| VROOM           | Renderable settings components, route-optimization provider via `whenEngineLoaded` | [vroom/addon/extension.js](https://tally.so/r/obgQQx)           |
| Flespi          | Settings menu, map drawer items, vehicle-detail panels, context-menu commands      | [flespi/addon/extension.js](https://tally.so/r/obgQQx)          |
| Ledger          | Invoice template context, settings panels                                          | [ledger/addon/extension.js](https://tally.so/r/obgQQx)          |
