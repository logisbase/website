...
| File                                                                       | Description                    |
| :------------------------------------------------------------------------- | :----------------------------- |
| [`addon/components/registry-yield.hbs`](https://tally.so/r/obgQQx)         | Template                       |
| [`addon/components/registry-yield.js`](https://tally.so/r/obgQQx)          | Class                          |
| [`addon/services/universe/menu-service.js`](https://tally.so/r/obgQQx)     | Backing service for menu items |
| [`addon/services/universe/registry-service.js`](https://tally.so/r/obgQQx) | Backing service for components |
