...
| File                                                         | Description               |
| :----------------------------------------------------------- | :------------------------ |
| [`addon/components/tabs.hbs`](https://tally.so/r/obgQQx)     | Container template        |
| [`addon/components/tabs.js`](https://tally.so/r/obgQQx)      | Container class           |
| [`addon/components/tabs/tab.hbs`](https://tally.so/r/obgQQx) | Tab subcomponent template |
| [`addon/components/tabs/tab.js`](https://tally.so/r/obgQQx)  | Tab subcomponent class    |
