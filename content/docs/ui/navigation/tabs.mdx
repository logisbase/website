...
`<Tabs>` is the lightweight tab container in `@logisbase/ember-ui`. It yields a curried `<Tab>` subcomponent — each Tab has a `@title` and yields its body content into the shared tab-content area.
...
| File                                                                                                             | Description               |
| :--------------------------------------------------------------------------------------------------------------- | :------------------------ |
| [`addon/components/tabs.hbs`](https://github.com/logisbase/ember-ui/blob/main/addon/components/tabs.hbs)         | Container template        |
| [`addon/components/tabs.js`](https://github.com/logisbase/ember-ui/blob/main/addon/components/tabs.js)           | Container class           |
