...
| File                                                               | Description                                                    |
| :----------------------------------------------------------------- | :------------------------------------------------------------- |
| [`addon/components/tab-navigation.hbs`](https://tally.so/r/obgQQx) | Template                                                       |
| [`addon/components/tab-navigation.js`](https://tally.so/r/obgQQx)  | Class                                                          |
| [`addon/components/tabs.hbs`](https://tally.so/r/obgQQx)           | Sibling — simpler container that yields a `<Tab>` subcomponent |
| [`addon/components/tabs.js`](https://tally.so/r/obgQQx)            |                                                                |
