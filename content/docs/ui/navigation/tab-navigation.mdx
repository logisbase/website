...
| File                                                                                                                         | Description                                                    |
| :--------------------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------- |
| [`addon/components/tab-navigation.hbs`](https://github.com/logisbase/ember-ui/blob/main/addon/components/tab-navigation.hbs) | Template                                                       |
| [`addon/components/tab-navigation.js`](https://github.com/logisbase/ember-ui/blob/main/addon/components/tab-navigation.js)   | Class                                                          |
| [`addon/components/tabs.hbs`](https://github.com/logisbase/ember-ui/blob/main/addon/components/tabs.hbs)                     | Sibling — simpler container that yields a `<Tab>` subcomponent |
| [`addon/components/tabs.js`](https://github.com/logisbase/ember-ui/blob/main/addon/components/tabs.js)                       |                                                                |
| [`addon/components/tabs/tab.hbs`](https://github.com/logisbase/ember-ui/blob/main/addon/components/tabs/tab.hbs)             | Tab subcomponent template                                      |
| [`addon/components/tabs/tab.js`](https://github.com/logisbase/ember-ui/blob/main/addon/components/tabs/tab.js)               | Tab subcomponent class                                         |
