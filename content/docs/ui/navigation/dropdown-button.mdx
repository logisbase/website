...
| File                                                                                                                           | Description |
| :----------------------------------------------------------------------------------------------------------------------------- | :---------- |
| [`addon/components/dropdown-button.hbs`](https://github.com/logisbase/ember-ui/blob/main/addon/components/dropdown-button.hbs) | Template    |
| [`addon/components/dropdown-button.js`](https://github.com/logisbase/ember-ui/blob/main/addon/components/dropdown-button.js)   | Class       |
