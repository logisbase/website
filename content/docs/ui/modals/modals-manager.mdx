...
`modals-manager` is the central service for working with modals from JavaScript. Every modal in the LogisBase Console — confirmations, alerts, prompts, bulk-action sheets, progress trackers, and custom modals — flows through this service.
...
```js
const selected = await this.modalsManager.userSelectOption('Pick a wallet', [
...
| File                                                                                                                   | Description   |
| :--------------------------------------------------------------------------------------------------------------------- | :------------ |
| [`addon/services/modals-manager.js`](https://github.com/logisbase/ember-ui/blob/main/addon/services/modals-manager.js) | Service class |
