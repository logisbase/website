---
title: Modal Layouts
description: Pre-built modal layouts in @logisbase/ember-ui — confirm, alert, prompt, bulk-action, progress, process, loading, and option-prompt.
---

# Modal Layouts

`@logisbase/ember-ui` ships several pre-built modal layouts. You don't render these directly — you call them via the [`modals-manager`](/docs/ui/modals/modals-manager) service. Each is just a convenience wrapper around `modalsManager.show()` with a layout component preset.
