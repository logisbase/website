...
| File                                                                                                         | Description |
| :----------------------------------------------------------------------------------------------------------- | :---------- |
| [`addon/components/drawer.hbs`](https://github.com/logisbase/ember-ui/blob/main/addon/components/drawer.hbs) | Template    |
| [`addon/components/drawer.js`](https://github.com/logisbase/ember-ui/blob/main/addon/components/drawer.js)   | Class       |
