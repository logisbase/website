...
| File                                                        | Description                                  |
| :---------------------------------------------------------- | :------------------------------------------- |
| [`addon/components/overlay.hbs`](https://tally.so/r/obgQQx) | Template                                     |
| [`addon/components/overlay.js`](https://tally.so/r/obgQQx)  | Class                                        |
| [`addon/components/overlay/`](https://tally.so/r/obgQQx)    | Subcomponents (header, body, footer regions) |
