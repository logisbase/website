...
| File                                                                                                                       | Description |
| :------------------------------------------------------------------------------------------------------------------------- | :---------- |
| [`addon/components/content-panel.hbs`](https://github.com/logisbase/ember-ui/blob/main/addon/components/content-panel.hbs) | Template    |
| [`addon/components/content-panel.js`](https://github.com/logisbase/ember-ui/blob/main/addon/components/content-panel.js)   | Class       |
