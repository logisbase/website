...
| File                                                                                                         | Description |
| :----------------------------------------------------------------------------------------------------------- | :---------- |
| [`addon/components/spacer.hbs`](https://github.com/logisbase/ember-ui/blob/main/addon/components/spacer.hbs) | Template    |
| [`addon/components/spacer.js`](https://github.com/logisbase/ember-ui/blob/main/addon/components/spacer.js)   | Class       |
