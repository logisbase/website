...
<button class='btn btn-default'>
  ...
  <Attach::Popover @showOn='click' @hideOn='clickout escapekey'>
    <div class='rounded bg-white p-4 shadow-lg'>
      <h4 class='mb-2 font-semibold'>Quick actions</h4>
...
| File                                                                                                                         | Description      |
| :--------------------------------------------------------------------------------------------------------------------------- | :--------------- |
| [`addon/components/attach/popover.hbs`](https://github.com/logisbase/ember-ui/blob/main/addon/components/attach/popover.hbs) | Popover template |
| [`addon/components/attach/popover.js`](https://github.com/logisbase/ember-ui/blob/main/addon/components/attach/popover.js)   | Popover class    |
