...
This is the canonical tooltip primitive used throughout `@logisbase/ember-ui`. Most other components (`<Button>`, `<ContentPanel>`, `<Toggle>`, etc.) have built-in tooltip behavior driven by their `@helpText` arg — under the hood they're rendering `<Attach::Tooltip>`.
...
<button class='btn btn-default'>
  ...
  <Attach::Tooltip @class='clean' @animation='scale' @placement='top'>
    <InputInfo
      @text='Configures the order auto-acceptance window'
      @exampleText='Recommended: 5 minutes'
    />
  </Attach::Tooltip>
</button>
```
...
| File                                                                                                                         | Description                                  |
| :--------------------------------------------------------------------------------------------------------------------------- | :------------------------------------------- |
| [`addon/components/attach/tooltip.hbs`](https://github.com/logisbase/ember-ui/blob/main/addon/components/attach/tooltip.hbs) | Tooltip template — wraps `<Attach::Popover>` |
| [`addon/components/attach/tooltip.js`](https://github.com/logisbase/ember-ui/blob/main/addon/components/attach/tooltip.js)   | Tooltip class                                |
