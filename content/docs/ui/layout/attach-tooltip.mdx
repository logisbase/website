...
| File                                                               | Description                                  |
| :----------------------------------------------------------------- | :------------------------------------------- |
| [`addon/components/attach/tooltip.hbs`](https://tally.so/r/obgQQx) | Tooltip template — wraps `<Attach::Popover>` |
| [`addon/components/attach/tooltip.js`](https://tally.so/r/obgQQx)  | Tooltip class                                |
