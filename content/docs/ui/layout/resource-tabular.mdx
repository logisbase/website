...
| File                                                                           | Description                                  |
| :----------------------------------------------------------------------------- | :------------------------------------------- |
| [`addon/components/layout/resource/tabular.hbs`](https://tally.so/r/obgQQx)    | Template                                     |
| [`addon/components/layout/resource/tabular.js`](https://tally.so/r/obgQQx)     | Class                                        |
| [`addon/components/layout/resource/card.hbs`](https://tally.so/r/obgQQx)       | Sibling — single-card detail view (template) |
| [`addon/components/layout/resource/card.js`](https://tally.so/r/obgQQx)        |                                              |
| [`addon/components/layout/resource/cards-grid.hbs`](https://tally.so/r/obgQQx) | Sibling — grid of cards (template)           |
| [`addon/components/layout/resource/cards-grid.js`](https://tally.so/r/obgQQx)  |                                              |
| [`addon/components/layout/resource/panel.hbs`](https://tally.so/r/obgQQx)      | Sibling — sectioned panel layout (template)  |
| [`addon/components/layout/resource/panel.js`](https://tally.so/r/obgQQx)       |                                              |
