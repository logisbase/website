...
| File                                                      | Description                                     |
| :-------------------------------------------------------- | :---------------------------------------------- |
| [`addon/components/table.hbs`](https://tally.so/r/obgQQx) | Template                                        |
| [`addon/components/table.js`](https://tally.so/r/obgQQx)  | Class                                           |
| [`addon/components/table/`](https://tally.so/r/obgQQx)    | Head, body, row, th, td, and all cell renderers |
