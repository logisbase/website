...
columns = [
  ...
  { label: 'Status', valuePath: 'status', cellComponent: 'table/cell/status' },
  {
    ...
    cellComponentArgs: { actions: this.rowActions },
  },
];
```
...
<Table
  ...
  @columns={{array
    (hash
      ...
      valuePath='public_id'
      sortable=true
      cellComponent='table/cell/click-to-copy'
    )
    ...
    (hash
      label=''
      cellComponent='table/cell/dropdown'
      cellComponentArgs=(hash actions=this.rowActions)
    )
  }}
  @selectable={{true}}
  @canSelectAll={{true}}
...
| File                                                                                                       | Description                                     |
| :--------------------------------------------------------------------------------------------------------- | :---------------------------------------------- |
| [`addon/components/table.hbs`](https://github.com/logisbase/ember-ui/blob/main/addon/components/table.hbs) | Template                                        |
| [`addon/components/table.js`](https://github.com/logisbase/ember-ui/blob/main/addon/components/table.js)   | Class                                           |
| [`addon/components/table/`](https://github.com/logisbase/ember-ui/tree/main/addon/components/table)        | Head, body, row, th, td, and all cell renderers |
