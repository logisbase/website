...
<Timeline @activity={{this.events}} as |Item|>
  <Item>
    ...
    <div class='text-xs'>{{format-date-fns
...
| File                                                                                                                       | Description                |
| :------------------------------------------------------------------------------------------------------------------------- | :------------------------- |
| [`addon/components/timeline.hbs`](https://github.com/logisbase/ember-ui/blob/main/addon/components/timeline.hbs)           | Template                   |
| [`addon/components/timeline.js`](https://github.com/logisbase/ember-ui/blob/main/addon/components/timeline.js)             | Class                      |
| [`addon/components/timeline/item.hbs`](https://github.com/logisbase/ember-ui/blob/main/addon/components/timeline/item.hbs) | Item subcomponent template |
| [`addon/components/timeline/item.js`](https://github.com/logisbase/ember-ui/blob/main/addon/components/timeline/item.js)   | Item subcomponent class    |
