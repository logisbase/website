...
| File                                                              | Description                |
| :---------------------------------------------------------------- | :------------------------- |
| [`addon/components/timeline.hbs`](https://tally.so/r/obgQQx)      | Template                   |
| [`addon/components/timeline.js`](https://tally.so/r/obgQQx)       | Class                      |
| [`addon/components/timeline/item.hbs`](https://tally.so/r/obgQQx) | Item subcomponent template |
| [`addon/components/timeline/item.js`](https://tally.so/r/obgQQx)  | Item subcomponent class    |
