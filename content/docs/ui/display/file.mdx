...
`<File>` renders a card-style preview of a LogisBase `file` record. It shows the image thumbnail (for images) or a file-type icon (for everything else), the truncated filename, and an optional actions dropdown with delete/download/preview entries.
...
| :------- | :---- | :-------------------------------------------------------------------- |
| `@file`  | model | The LogisBase `file` record (must have `original_filename` and `url`) |
...
| File                                                                                                               | Description                           |
| :----------------------------------------------------------------------------------------------------------------- | :------------------------------------ |
| [`addon/components/file.hbs`](https://github.com/logisbase/ember-ui/blob/main/addon/components/file.hbs)           | Template                              |
| [`addon/components/file.js`](https://github.com/logisbase/ember-ui/blob/main/addon/components/file.js)             | Class                                 |
| [`addon/components/file-icon.hbs`](https://github.com/logisbase/ember-ui/blob/main/addon/components/file-icon.hbs) | Sibling — small inline file-type icon |
| [`addon/components/file-icon.js`](https://github.com/logisbase/ember-ui/blob/main/addon/components/file-icon.js)   |                                       |
