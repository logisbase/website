...
| File                                                          | Description                           |
| :------------------------------------------------------------ | :------------------------------------ |
| [`addon/components/file.hbs`](https://tally.so/r/obgQQx)      | Template                              |
| [`addon/components/file.js`](https://tally.so/r/obgQQx)       | Class                                 |
| [`addon/components/file-icon.hbs`](https://tally.so/r/obgQQx) | Sibling — small inline file-type icon |
| [`addon/components/file-icon.js`](https://tally.so/r/obgQQx)  |                                       |
