...
| File                                                                                                           | Description |
| :------------------------------------------------------------------------------------------------------------- | :---------- |
| [`addon/components/spinner.hbs`](https://github.com/logisbase/ember-ui/blob/main/addon/components/spinner.hbs) | Template    |
| [`addon/components/spinner.js`](https://github.com/logisbase/ember-ui/blob/main/addon/components/spinner.js)   | Class       |
