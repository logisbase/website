...
| File                                                             | Description                                     |
| :--------------------------------------------------------------- | :---------------------------------------------- |
| [`addon/components/activity-log.hbs`](https://tally.so/r/obgQQx) | Template                                        |
| [`addon/components/activity-log.js`](https://tally.so/r/obgQQx)  | Class — queries the `activity` Ember Data model |
