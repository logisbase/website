...
```handlebars
<ActivityLog @subjectId={{this.order.id}} @causerId={{this.user.id}} />
```
...
| File                                                                                                                     | Description                                     |
| :----------------------------------------------------------------------------------------------------------------------- | :---------------------------------------------- |
| [`addon/components/activity-log.hbs`](https://github.com/logisbase/ember-ui/blob/main/addon/components/activity-log.hbs) | Template                                        |
| [`addon/components/activity-log.js`](https://github.com/logisbase/ember-ui/blob/main/addon/components/activity-log.js)   | Class — queries the `activity` Ember Data model |
