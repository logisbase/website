...
| File                                                                       | Description           |
| :------------------------------------------------------------------------- | :-------------------- |
| [`addon/components/comment-thread.hbs`](https://tally.so/r/obgQQx)         | Template              |
| [`addon/components/comment-thread.js`](https://tally.so/r/obgQQx)          | Class                 |
| [`addon/components/comment-thread/comment.hbs`](https://tally.so/r/obgQQx) | Subcomponent template |
| [`addon/components/comment-thread/comment.js`](https://tally.so/r/obgQQx)  | Subcomponent class    |
