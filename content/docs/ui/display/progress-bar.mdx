...
| File                                                                                                                     | Description |
| :----------------------------------------------------------------------------------------------------------------------- | :---------- |
| [`addon/components/progress-bar.hbs`](https://github.com/logisbase/ember-ui/blob/main/addon/components/progress-bar.hbs) | Template    |
| [`addon/components/progress-bar.js`](https://github.com/logisbase/ember-ui/blob/main/addon/components/progress-bar.js)   | Class       |
