...
| File                                                                                                               | Description |
| :----------------------------------------------------------------------------------------------------------------- | :---------- |
| [`addon/components/combo-box.hbs`](https://github.com/logisbase/ember-ui/blob/main/addon/components/combo-box.hbs) | Template    |
| [`addon/components/combo-box.js`](https://github.com/logisbase/ember-ui/blob/main/addon/components/combo-box.js)   | Class       |
