...
| File                                                                                                         | Description |
| :----------------------------------------------------------------------------------------------------------- | :---------- |
| [`addon/components/toggle.hbs`](https://github.com/logisbase/ember-ui/blob/main/addon/components/toggle.hbs) | Template    |
| [`addon/components/toggle.js`](https://github.com/logisbase/ember-ui/blob/main/addon/components/toggle.js)   | Class       |
