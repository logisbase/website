...
The user's country is auto-detected from their IP via LogisBase's geolocation service (with US as the fallback).
...
<PhoneInput
  ...
  @onInput={{fn (mut this.driver.phone)}}
/>
```
...
2. The user's IP via `lookupUserIp` from `@logisbase/ember-core`
...
| File                                                                                                                   | Description                                                                  |
| :--------------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------- |
| [`addon/components/phone-input.hbs`](https://github.com/logisbase/ember-ui/blob/main/addon/components/phone-input.hbs) | Template                                                                     |
| [`addon/components/phone-input.js`](https://github.com/logisbase/ember-ui/blob/main/addon/components/phone-input.js)   | Class — wraps [`intl-tel-input`](https://github.com/jackocnr/intl-tel-input) |
