...
| File                                                            | Description                                                 |
| :-------------------------------------------------------------- | :---------------------------------------------------------- |
| [`addon/components/phone-input.hbs`](https://tally.so/r/obgQQx) | Template                                                    |
| [`addon/components/phone-input.js`](https://tally.so/r/obgQQx)  | Class — wraps [`intl-tel-input`](https://tally.so/r/obgQQx) |
