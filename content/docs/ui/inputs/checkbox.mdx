...
<Checkbox
  @value={{this.includeFreight}}
  @label='Include freight charges'
  @onToggle={{fn (mut this.includeFreight)}}
/>
...
| File                                                                                                             | Description |
| :--------------------------------------------------------------------------------------------------------------- | :---------- |
| [`addon/components/checkbox.hbs`](https://github.com/logisbase/ember-ui/blob/main/addon/components/checkbox.hbs) | Template    |
| [`addon/components/checkbox.js`](https://github.com/logisbase/ember-ui/blob/main/addon/components/checkbox.js)   | Class       |
