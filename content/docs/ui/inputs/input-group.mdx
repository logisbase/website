---
title: InputGroup
description: '<InputGroup> wraps a label, an input, and helper text into a single form field. The most-used component in @logisbase/ember-ui — every form is built from these.'
---
...
It is the most-used component in `@logisbase/ember-ui` — practically every form in the LogisBase Console is composed from these.
...
| File                                                                                                                   | Description |
| :--------------------------------------------------------------------------------------------------------------------- | :---------- |
| [`addon/components/input-group.hbs`](https://github.com/logisbase/ember-ui/blob/main/addon/components/input-group.hbs) | Template    |
| [`addon/components/input-group.js`](https://github.com/logisbase/ember-ui/blob/main/addon/components/input-group.js)   | Class       |
