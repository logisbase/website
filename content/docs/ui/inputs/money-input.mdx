...
| File                                                            | Description                                |
| :-------------------------------------------------------------- | :----------------------------------------- |
| [`addon/components/money-input.hbs`](https://tally.so/r/obgQQx) | Template                                   |
| [`addon/components/money-input.js`](https://tally.so/r/obgQQx)  | Class                                      |
| [`addon/components/money-input/`](https://tally.so/r/obgQQx)    | `CurrencyHandle` and related subcomponents |
