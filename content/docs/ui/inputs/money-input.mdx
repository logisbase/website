...
| File                                                                                                                   | Description                                |
| :--------------------------------------------------------------------------------------------------------------------- | :----------------------------------------- |
| [`addon/components/money-input.hbs`](https://github.com/logisbase/ember-ui/blob/main/addon/components/money-input.hbs) | Template                                   |
| [`addon/components/money-input.js`](https://github.com/logisbase/ember-ui/blob/main/addon/components/money-input.js)   | Class                                      |
| [`addon/components/money-input/`](https://github.com/logisbase/ember-ui/tree/main/addon/components/money-input)        | `CurrencyHandle` and related subcomponents |
