...
`<Select>` is the standard single-value dropdown. It wraps a native `<select>` element with LogisBase's form styling, plus convenience for option labels, value paths, and humanization.

For an autocomplete / typeahead, use [`<ComboBox>`](/docs/ui/inputs/combo-box). For selecting a LogisBase model record, use [`<ModelSelect>`](/docs/ui/inputs/model-select).
...
| File                                                                                                         | Description |
| :----------------------------------------------------------------------------------------------------------- | :---------- |
| [`addon/components/select.hbs`](https://github.com/logisbase/ember-ui/blob/main/addon/components/select.hbs) | Template    |
| [`addon/components/select.js`](https://github.com/logisbase/ember-ui/blob/main/addon/components/select.js)   | Class       |
