...
| File                                                                      | Description                   |
| :------------------------------------------------------------------------ | :---------------------------- |
| [`addon/components/model-select.hbs`](https://tally.so/r/obgQQx)          | Template                      |
| [`addon/components/model-select.js`](https://tally.so/r/obgQQx)           | Class                         |
| [`addon/components/model-select-multiple.hbs`](https://tally.so/r/obgQQx) | Sibling — multi-value variant |
| [`addon/components/model-select-multiple.js`](https://tally.so/r/obgQQx)  |                               |
