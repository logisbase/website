...
`<ModelSelect>` is a typeahead select for Ember Data model records. It live-queries your registered store as the user types and supports infinite scroll. It is the standard way to let a user pick a driver, vehicle, customer, store, or any other LogisBase resource.
...
<ModelSelect
  @modelName='driver'
  @selectedModel={{this.driver}}
  @onChange={{fn (mut this.driver)}}
  as |driver|
>
...
| File                                                                                                                                       | Description                   |
| :----------------------------------------------------------------------------------------------------------------------------------------- | :---------------------------- |
| [`addon/components/model-select.hbs`](https://github.com/logisbase/ember-ui/blob/main/addon/components/model-select.hbs)                   | Template                      |
| [`addon/components/model-select.js`](https://github.com/logisbase/ember-ui/blob/main/addon/components/model-select.js)                     | Class                         |
| [`addon/components/model-select-multiple.hbs`](https://github.com/logisbase/ember-ui/blob/main/addon/components/model-select-multiple.hbs) | Sibling — multi-value variant |
| [`addon/components/model-select-multiple.js`](https://github.com/logisbase/ember-ui/blob/main/addon/components/model-select-multiple.js)   |                               |
