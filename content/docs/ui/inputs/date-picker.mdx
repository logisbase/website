...
| File                                                            | Description                                                  |
| :-------------------------------------------------------------- | :----------------------------------------------------------- |
| [`addon/components/date-picker.hbs`](https://tally.so/r/obgQQx) | Template                                                     |
| [`addon/components/date-picker.js`](https://tally.so/r/obgQQx)  | Class — wraps [`air-datepicker`](https://air-datepicker.com) |
