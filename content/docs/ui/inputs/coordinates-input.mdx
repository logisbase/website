...
- `<ModelCoordinatesInput>` — same component, but bound to a LogisBase model's `location` polygon

## Source

| File                                                                                                                                           | Description                                       |
| :--------------------------------------------------------------------------------------------------------------------------------------------- | :------------------------------------------------ |
| [`addon/components/coordinates-input.hbs`](https://github.com/logisbase/ember-ui/blob/main/addon/components/coordinates-input.hbs)             | Template                                          |
| [`addon/components/coordinates-input.js`](https://github.com/logisbase/ember-ui/blob/main/addon/components/coordinates-input.js)               | Class — uses Leaflet via the `leaflet` service    |
| [`addon/components/model-coordinates-input.hbs`](https://github.com/logisbase/ember-ui/blob/main/addon/components/model-coordinates-input.hbs) | Sibling — bound to a LogisBase model's `location` |
| [`addon/components/model-coordinates-input.js`](https://github.com/logisbase/ember-ui/blob/main/addon/components/model-coordinates-input.js)   |                                                   |
