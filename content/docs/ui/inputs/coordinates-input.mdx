...
| File                                                                        | Description                                       |
| :-------------------------------------------------------------------------- | :------------------------------------------------ |
| [`addon/components/coordinates-input.hbs`](https://tally.so/r/obgQQx)       | Template                                          |
| [`addon/components/coordinates-input.js`](https://tally.so/r/obgQQx)        | Class — uses Leaflet via the `leaflet` service    |
| [`addon/components/model-coordinates-input.hbs`](https://tally.so/r/obgQQx) | Sibling — bound to a LogisBase model's `location` |
| [`addon/components/model-coordinates-input.js`](https://tally.so/r/obgQQx)  |                                                   |
