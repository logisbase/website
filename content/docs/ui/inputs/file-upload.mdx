...
| File                                                              | Description                                         |
| :---------------------------------------------------------------- | :-------------------------------------------------- |
| [`addon/components/file-upload.hbs`](https://tally.so/r/obgQQx)   | Template (template-only)                            |
| [`addon/components/upload-button.hbs`](https://tally.so/r/obgQQx) | Sibling — ready-made trigger button (template-only) |

Wraps [`ember-file-upload`](https://tally.so/r/obgQQx).
