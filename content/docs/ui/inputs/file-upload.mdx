...
<FileUpload
  @name='avatar'
  @accept='image/*'
  @onFileAdded={{this.handleFile}}
  as |queue|
>
  <Button
    @icon='upload'
    @text='Upload avatar'
    {{on 'click' queue.selectFile}}
  />
</FileUpload>
```
...
| File                                                                                                                       | Description                                         |
| :------------------------------------------------------------------------------------------------------------------------- | :-------------------------------------------------- |
| [`addon/components/file-upload.hbs`](https://github.com/logisbase/ember-ui/blob/main/addon/components/file-upload.hbs)     | Template (template-only)                            |
| [`addon/components/upload-button.hbs`](https://github.com/logisbase/ember-ui/blob/main/addon/components/upload-button.hbs) | Sibling — ready-made trigger button (template-only) |
