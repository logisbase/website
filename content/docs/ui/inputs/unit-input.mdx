...
| File                                                                                                                 | Description               |
| :------------------------------------------------------------------------------------------------------------------- | :------------------------ |
| [`addon/components/unit-input.hbs`](https://github.com/logisbase/ember-ui/blob/main/addon/components/unit-input.hbs) | Template                  |
| [`addon/components/unit-input.js`](https://github.com/logisbase/ember-ui/blob/main/addon/components/unit-input.js)   | Class                     |
| [`addon/components/unit-input/`](https://github.com/logisbase/ember-ui/tree/main/addon/components/unit-input)        | `UnitHandle` subcomponent |
