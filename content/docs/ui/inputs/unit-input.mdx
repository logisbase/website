...
| File                                                           | Description               |
| :------------------------------------------------------------- | :------------------------ |
| [`addon/components/unit-input.hbs`](https://tally.so/r/obgQQx) | Template                  |
| [`addon/components/unit-input.js`](https://tally.so/r/obgQQx)  | Class                     |
| [`addon/components/unit-input/`](https://tally.so/r/obgQQx)    | `UnitHandle` subcomponent |
