...
| File                                                                        | Description                                       |
| :-------------------------------------------------------------------------- | :------------------------------------------------ |
| [`addon/components/model-coordinates-input.hbs`](https://tally.so/r/obgQQx) | Template — wraps `<CoordinatesInput>`             |
| [`addon/components/model-coordinates-input.js`](https://tally.so/r/obgQQx)  | Class — handles model binding and reverse-geocode |
