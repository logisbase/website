...
| [`addon/services/universe/widget-service.js`](https://github.com/logisbase/ember-ui/blob/main/addon/services/universe/widget-service.js) | Companion service — manages the registry of available widgets |
