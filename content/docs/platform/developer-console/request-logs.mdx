---
title: Request Logs
description: Inspect a complete, filterable history of every API request made to your LogisBase instance.
---

# Request Logs

Request Logs records every inbound API request to your LogisBase instance. Use it to debug integration issues, audit API usage, or trace unexpected behaviour back to a specific call. Navigate to **Developers → Request Logs**.
...
The exact JSON payload returned by LogisBase. For failed requests, the error message and validation details appear here — this is usually the fastest way to understand why a request failed.
