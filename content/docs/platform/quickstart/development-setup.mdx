...
LogisBase is licensed under the (Source-accessible)\*\*. If you modify LogisBase or build extensions that run as part of a networked service, the Source-accessible requires that you make your modified source code publicly accessible to users of that service.
