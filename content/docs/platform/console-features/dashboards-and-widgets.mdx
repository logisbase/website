...
The LogisBase Console home screen is a fully customizable dashboard. Drag, resize, and arrange widgets to surface the metrics and views most relevant to your work. Extensions register their own widget types, and each user can create and manage multiple dashboards.
...
See [Extending LogisBase](/docs/extending-logisbase) for details on building and registering custom widgets.
