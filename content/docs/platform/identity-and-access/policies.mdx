---
title: Policies
description: Create reusable permission bundles that can be attached to users and roles across your LogisBase organization.
---
...
| Type                     | Description                                                                                                        |
| :----------------------- | :----------------------------------------------------------------------------------------------------------------- |
| **FLB Managed**          | Built-in policies shipped by LogisBase. Read-only — can be attached to users and roles, but not edited or deleted. |
