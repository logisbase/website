---
title: Documentation
description: How to contribute to LogisBase documentation — fixing typos, adding examples, capturing screenshots, and writing new pages.
sidebarTitle: Documentation
---

# Documentation contributions

The documentation you're reading right now lives in the [`logisbase/logisbase.io`](https://github.com/logisbase/logisbase.io) repository. Every page is editable. If something is wrong, unclear, or missing — submit a PR.
...
<Steps>
  <Step>
    ...
    ```bash
    git clone https://github.com/logisbase/logisbase.io.git
    cd logisbase.com
    ```
...
The `/docs/api/*` pages are **auto-generated** from the [postman submodule](https://github.com/logisbase/postman). Don't edit them directly — your changes will be overwritten on the next build.

To improve the API reference:

- For **endpoint docs, parameters, examples** → edit the YAML files in [`logisbase/postman`](https://github.com/logisbase/postman) and submit a PR there
...
See [`scripts/README.md`](https://github.com/logisbase/logisbase.io/blob/main/scripts/README.md) in the docs repo for the full generator architecture.
