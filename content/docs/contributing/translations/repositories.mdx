...
| :------------------------------------------------------- | :---------------------- | :------------------------------------------------------------------------------- |
| [`logisbase/logisbase`](https://tally.so/r/obgQQx)       | `console/translations/` | Console shell — top nav, settings, account, auth, shared UI, navigation menus    |
| [`logisbase/fleetops`](https://tally.so/r/obgQQx)        | `translations/`         | FleetOps — orders, drivers, vehicles, fleets, dispatching, live map, maintenance |
| [`logisbase/storefront`](https://tally.so/r/obgQQx)      | `translations/`         | Storefront — products, catalogs, orders, customers, networks, food trucks        |
| [`logisbase/pallet`](https://tally.so/r/obgQQx)          | `translations/`         | Pallet — warehouse operations, inventory, pick/pack/fulfillment                  |
| [`logisbase/ledger`](https://tally.so/r/obgQQx)          | `translations/`         | Ledger — invoices, payments, wallets, accounting, reports                        |
| [`logisbase/iam-engine`](https://tally.so/r/obgQQx)      | `translations/`         | IAM — users, roles, groups, policies, permissions                                |
| [`logisbase/dev-engine`](https://tally.so/r/obgQQx)      | `translations/`         | Developer Console — API keys, webhooks, logs, events, sandbox                    |
| [`logisbase/registry-bridge`](https://tally.so/r/obgQQx) | `translations/`         | Extensions Marketplace — install/purchase flow, listings, developer tools        |
...
| Repository                                              | Covers                                                                   |
| :------------------------------------------------------ | :----------------------------------------------------------------------- |
| [`logisbase/navigator-app`](https://tally.so/r/obgQQx)  | Navigator — driver-facing app for completing deliveries                  |
| [`logisbase/storefront-app`](https://tally.so/r/obgQQx) | Storefront — customer-facing app for browsing stores and tracking orders |
