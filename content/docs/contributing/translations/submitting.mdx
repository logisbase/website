...
- [ ] No translated brand names (LogisBase, FleetOps, etc.)
- [ ] File is UTF-8

If you ran LogisBase locally, click through the screens you translated and check that nothing overflows, breaks the layout, or looks wrong in context.
...
- [x] Ran logisbase console with FLEETBASE_LOCALE=es-mx
...
- For LogisBase Cloud, the next deploy after the merged release
...
| Translated brand names (LogisBase → "Base de Flotte")  | Keep brand names in English                                      |
