...
Real example: [`pallet/server/src/routes.php`](https://tally.so/r/obgQQx).

## Route Macros

`logisbase/core-api` defines three route macros via [`Route` expansion](https://tally.so/r/obgQQx):
...
Both groups include throttling, request logging, and route binding. `logisbase.protected` additionally runs `SetupLogisBaseSession`, the `AuthorizationGuard`, and presence tracking — defined in [`CoreServiceProvider::$middleware`](https://tally.so/r/obgQQx).
...
Real example: [`ledger/server/src/Http/Controllers/Internal/v1/InvoiceController.php`](https://tally.so/r/obgQQx).
...
| [`src/Routing/RESTRegistrar.php`](https://tally.so/r/obgQQx)                                        | REST route generator                                            |
| [`src/Http/Controllers/LogisBaseController.php`](https://tally.so/r/obgQQx)                         | Abstract resource controller base                               |
| [`src/Traits/HasApiControllerBehavior.php`](https://tally.so/r/obgQQx)                              | Trait that wires up the action methods                          |
| [`ledger/server/src/Http/Controllers/Internal/v1/InvoiceController.php`](https://tally.so/r/obgQQx) | Reference resource controller                                   |
| [`pallet/server/src/routes.php`](https://tally.so/r/obgQQx)                                         | Reference routes file                                           |
