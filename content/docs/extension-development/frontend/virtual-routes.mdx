...
| File                                                                              | Description                                    |
| :-------------------------------------------------------------------------------- | :--------------------------------------------- |
| [`console/app/routes/console/settings/virtual.js`](https://tally.so/r/obgQQx)     | Settings virtual route                         |
| [`console/app/routes/console/admin/virtual.js`](https://tally.so/r/obgQQx)        | Admin virtual route                            |
| [`console/app/templates/console/settings/virtual.hbs`](https://tally.so/r/obgQQx) | Renders `<LazyEngineComponent>`                |
| [`addon/services/universe/menu-service.js`](https://tally.so/r/obgQQx)            | `lookupMenuItem`, default routes per registrar |
