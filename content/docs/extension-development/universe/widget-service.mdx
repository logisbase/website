...
Real example: [`packages/storefront/addon/extension.js:55`](https://tally.so/r/obgQQx).
...
Real example: [`packages/ledger/addon/extension.js:185`](https://tally.so/r/obgQQx) — Ledger registers its own dashboard, attaches its full widget set there, and additionally exposes a curated subset on the built-in `'dashboard'`.
...
| File                                                                     | Description                         |
| :----------------------------------------------------------------------- | :---------------------------------- |
| [`addon/services/universe/widget-service.js`](https://tally.so/r/obgQQx) | `WidgetService`                     |
| [`addon/contracts/widget.js`](https://tally.so/r/obgQQx)                 | `Widget` contract                   |
| [`packages/storefront/addon/extension.js`](https://tally.so/r/obgQQx)    | Single-widget on built-in dashboard |
| [`packages/ledger/addon/extension.js`](https://tally.so/r/obgQQx)        | Custom dashboard + widget set       |
