...
description: Register dashboards and widgets that show up on the LogisBase home dashboard or your extension's own dashboard surface.
---
...
Real example: [`packages/storefront/addon/extension.js:55`](https://github.com/logisbase/logisbase/blob/main/packages/storefront/addon/extension.js#L55).
...
Real example: [`packages/ledger/addon/extension.js:185`](https://github.com/logisbase/logisbase/blob/main/packages/ledger/addon/extension.js#L185) — Ledger registers its own dashboard, attaches its full widget set there, and additionally exposes a curated subset on the built-in `'dashboard'`.
...
<div class='widget'>
  ...
  {{else}}
    ...
    <div class='text-secondary text-xs'>Total orders this week</div>
  {{/if}}
</div>
```
...
| File                                                                                                                                       | Description                         |
| :----------------------------------------------------------------------------------------------------------------------------------------- | :---------------------------------- |
| [`addon/services/universe/widget-service.js`](https://github.com/logisbase/ember-core/blob/main/addon/services/universe/widget-service.js) | `WidgetService`                     |
| [`addon/contracts/widget.js`](https://github.com/logisbase/ember-core/blob/main/addon/contracts/widget.js)                                 | `Widget` contract                   |
| [`packages/storefront/addon/extension.js`](https://github.com/logisbase/logisbase/blob/main/packages/storefront/addon/extension.js)        | Single-widget on built-in dashboard |
| [`packages/ledger/addon/extension.js`](https://github.com/logisbase/logisbase/blob/main/packages/ledger/addon/extension.js)                | Custom dashboard + widget set       |
