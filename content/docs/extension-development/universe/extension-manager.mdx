...
Real example: [`vroom/addon/extension.js:6`](https://tally.so/r/obgQQx) — VROOM waits for Fleet-Ops, loads its own engine, and plugs its routing implementation into the Fleet-Ops route-optimization service.
...
| File                                                                        | Description                               |
| :-------------------------------------------------------------------------- | :---------------------------------------- |
| [`addon/services/universe/extension-manager.js`](https://tally.so/r/obgQQx) | `ExtensionManagerService`                 |
| [`addon/contracts/extension-boot-state.js`](https://tally.so/r/obgQQx)      | Shared boot-state singleton               |
| [`vroom/addon/extension.js`](https://tally.so/r/obgQQx)                     | `whenEngineLoaded` + `ensureEngineLoaded` |
| [`valhalla/addon/extension.js`](https://tally.so/r/obgQQx)                  | Same pattern — routing-engine integration |
