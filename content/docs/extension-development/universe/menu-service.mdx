...
Real example: [`packages/ledger/addon/extension.js:92`](https://tally.so/r/obgQQx) — registers an "Invoice" tab on the Fleet-Ops order details panel.
...
| :--------- | :--------------------------------------------------- | :--------------------------------------------------------- |
| Fleet-Ops  | Header item with shortcuts + admin panel             | [fleetops/addon/extension.js](https://tally.so/r/obgQQx)   |
| Storefront | Header item with shortcuts + component contributions | [storefront/addon/extension.js](https://tally.so/r/obgQQx) |
| Pallet     | Header item, component contributions                 | [pallet/addon/extension.js](https://tally.so/r/obgQQx)     |
| Ledger     | Header item, custom dashboard, Fleet-Ops order tab   | [ledger/addon/extension.js](https://tally.so/r/obgQQx)     |
...
| File                                                                   | Description                    |
| :--------------------------------------------------------------------- | :----------------------------- |
| [`addon/services/universe/menu-service.js`](https://tally.so/r/obgQQx) | The MenuService implementation |
