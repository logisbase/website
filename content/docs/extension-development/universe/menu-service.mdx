...
Real example: [`packages/ledger/addon/extension.js:92`](https://github.com/logisbase/ledger/blob/main/addon/extension.js#L92) — registers an "Invoice" tab on the Fleet-Ops order details panel.
...
| :--------- | :--------------------------------------------------- | :---------------------------------------------------------------------------------------------------- |
| Fleet-Ops  | Header item with shortcuts + admin panel             | [fleetops/addon/extension.js](https://github.com/logisbase/fleetops/blob/main/addon/extension.js)     |
| Storefront | Header item with shortcuts + component contributions | [storefront/addon/extension.js](https://github.com/logisbase/storefront/blob/main/addon/extension.js) |
| Pallet     | Header item, component contributions                 | [pallet/addon/extension.js](https://github.com/logisbase/pallet/blob/main/addon/extension.js)         |
| Ledger     | Header item, custom dashboard, Fleet-Ops order tab   | [ledger/addon/extension.js](https://github.com/logisbase/ledger/blob/main/addon/extension.js)         |
...
| File                                                                                                                                   | Description                    |
| :------------------------------------------------------------------------------------------------------------------------------------- | :----------------------------- |
| [`addon/services/universe/menu-service.js`](https://github.com/logisbase/ember-core/blob/main/addon/services/universe/menu-service.js) | The MenuService implementation |
