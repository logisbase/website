...
| File                                                                   | Description                |
| :--------------------------------------------------------------------- | :------------------------- |
| [`addon/services/universe/hook-service.js`](https://tally.so/r/obgQQx) | `HookService`              |
| [`addon/contracts/hook.js`](https://tally.so/r/obgQQx)                 | `Hook` contract            |
| [`addon/contracts/hook-registry.js`](https://tally.so/r/obgQQx)        | Internal singleton storage |
