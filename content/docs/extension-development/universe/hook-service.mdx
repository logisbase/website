...
const results = await hookService.execute(
...
| File                                                                                                                                   | Description                |
| :------------------------------------------------------------------------------------------------------------------------------------- | :------------------------- |
| [`addon/services/universe/hook-service.js`](https://github.com/logisbase/ember-core/blob/main/addon/services/universe/hook-service.js) | `HookService`              |
| [`addon/contracts/hook.js`](https://github.com/logisbase/ember-core/blob/main/addon/contracts/hook.js)                                 | `Hook` contract            |
| [`addon/contracts/hook-registry.js`](https://github.com/logisbase/ember-core/blob/main/addon/contracts/hook-registry.js)               | Internal singleton storage |
