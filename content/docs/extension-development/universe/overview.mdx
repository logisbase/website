---
title: Overview
description: The UniverseService is the central extensibility facade in @logisbase/ember-core. It exposes five sub-services for menus, registries, widgets, hooks, and engines — and is the single entry point your extension uses to plug into the console.
---

# Universe Service

The **`UniverseService`** is the central extensibility facade in `@logisbase/ember-core`. It is the entry point your extension uses to register everything: menu items, components, widgets, hooks, registries, and engine integrations.
...
| `universe.extensionManager.isInstalled(name)`                      | Whether an extension is installed in this LogisBase deployment                                                                                            |
...
| :--------- | :-------------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------------- |
| Storefront | Header menu with shortcuts, dashboard widget, registry components           | [storefront/addon/extension.js](https://github.com/logisbase/storefront/blob/main/addon/extension.js) |
| Fleet-Ops  | Header item with shortcuts, admin panel, custom registries (40+), widget    | [fleetops/addon/extension.js](https://github.com/logisbase/fleetops/blob/main/addon/extension.js)     |
| VROOM      | `whenEngineLoaded` to register a route-optimization provider into Fleet-Ops | [vroom/addon/extension.js](https://github.com/logisbase/vroom/blob/main/addon/extension.js)           |
| Valhalla   | `whenEngineLoaded` to register a routing engine into Fleet-Ops              | [valhalla/addon/extension.js](https://github.com/logisbase/valhalla/blob/main/addon/extension.js)     |
| Pallet     | Header menu, settings registries                                            | [pallet/addon/extension.js](https://github.com/logisbase/pallet/blob/main/addon/extension.js)         |
| Ledger     | Custom dashboard, multiple widgets, Fleet-Ops order-details tab             | [ledger/addon/extension.js](https://github.com/logisbase/ledger/blob/main/addon/extension.js)         |

## Source

| File                                                                                                         | Description                                              |
| :----------------------------------------------------------------------------------------------------------- | :------------------------------------------------------- |
| [`addon/services/universe.js`](https://github.com/logisbase/ember-core/blob/main/addon/services/universe.js) | The `UniverseService` façade                             |
| [`addon/services/universe/`](https://github.com/logisbase/ember-core/tree/main/addon/services/universe)      | All five sub-services                                    |
| [`addon/contracts/`](https://github.com/logisbase/ember-core/tree/main/addon/contracts)                      | `MenuItem`, `Widget`, `Hook`, `ExtensionComponent`, etc. |
