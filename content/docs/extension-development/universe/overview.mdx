...
| :--------- | :-------------------------------------------------------------------------- | :--------------------------------------------------------- |
| Storefront | Header menu with shortcuts, dashboard widget, registry components           | [storefront/addon/extension.js](https://tally.so/r/obgQQx) |
| Fleet-Ops  | Header item with shortcuts, admin panel, custom registries (40+), widget    | [fleetops/addon/extension.js](https://tally.so/r/obgQQx)   |
| VROOM      | `whenEngineLoaded` to register a route-optimization provider into Fleet-Ops | [vroom/addon/extension.js](https://tally.so/r/obgQQx)      |
...
| Pallet     | Header menu, settings registries                                            | [pallet/addon/extension.js](https://tally.so/r/obgQQx)     |
| Ledger     | Custom dashboard, multiple widgets, Fleet-Ops order-details tab             | [ledger/addon/extension.js](https://tally.so/r/obgQQx)     |

## Source

| File                                                      | Description                                              |
| :-------------------------------------------------------- | :------------------------------------------------------- |
| [`addon/services/universe.js`](https://tally.so/r/obgQQx) | The `UniverseService` façade                             |
| [`addon/services/universe/`](https://tally.so/r/obgQQx)   | All five sub-services                                    |
| [`addon/contracts/`](https://tally.so/r/obgQQx)           | `MenuItem`, `Widget`, `Hook`, `ExtensionComponent`, etc. |
