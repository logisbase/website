...
For Fleet-Ops's full list of slots, see [`fleetops/addon/extension.js#createRegistries`](https://tally.so/r/obgQQx).
...
| :--------- | :----------------------------------------------------------------------------------------------- | :--------------------------------------------------------- |
| Fleet-Ops  | Creates 40+ registries for its own slots                                                         | [fleetops/addon/extension.js](https://tally.so/r/obgQQx)   |
| Storefront | Registers components into `fleet-ops:component:order:details`                                    | [storefront/addon/extension.js](https://tally.so/r/obgQQx) |
| VROOM      | Registers `fleet-ops:template:settings:routing` and `fleet-ops:component:admin:routing-settings` | [vroom/addon/extension.js](https://tally.so/r/obgQQx)      |
| Valhalla   | Registers settings components into Fleet-Ops routing slots                                       | [valhalla/addon/extension.js](https://tally.so/r/obgQQx)   |
| Ledger     | Registers an order-details tab into Fleet-Ops                                                    | [ledger/addon/extension.js](https://tally.so/r/obgQQx)     |
...
| File                                                                       | Description                    |
| :------------------------------------------------------------------------- | :----------------------------- |
| [`addon/services/universe/registry-service.js`](https://tally.so/r/obgQQx) | RegistryService implementation |
| [`addon/contracts/extension-component.js`](https://tally.so/r/obgQQx)      | `ExtensionComponent`           |
| [`addon/contracts/registry.js`](https://tally.so/r/obgQQx)                 | `Registry`                     |
