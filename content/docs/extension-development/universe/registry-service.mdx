...
| Form                                     | Example                                                               |
| :--------------------------------------- | :-------------------------------------------------------------------- |
| `ExtensionComponent` instance            | `new ExtensionComponent('@logisbase/my-engine', 'components/my-tab')` |
...
Real engines expose these slots (extracted from the `extension.js` files of the source-accessible extensions):
...
| `@logisbase/console`                                      | App-wide tour/launcher/guard components (rare — only system extensions use this) |

For Fleet-Ops's full list of slots, see [`fleetops/addon/extension.js#createRegistries`](https://github.com/logisbase/fleetops/blob/main/addon/extension.js).
...
```js
import TemplateHelper from '@logisbase/ember-core/contracts/template-helper';

registryService.registerHelper(
  'calculate-delivery-fee',
  new TemplateHelper(
    '@logisbase/storefront-engine',
    'helpers/calculate-delivery-fee',
  ),
);
```
...
| :--------- | :----------------------------------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------------- |
| Fleet-Ops  | Creates 40+ registries for its own slots                                                         | [fleetops/addon/extension.js](https://github.com/logisbase/fleetops/blob/main/addon/extension.js)     |
| Storefront | Registers components into `fleet-ops:component:order:details`                                    | [storefront/addon/extension.js](https://github.com/logisbase/storefront/blob/main/addon/extension.js) |
| VROOM      | Registers `fleet-ops:template:settings:routing` and `fleet-ops:component:admin:routing-settings` | [vroom/addon/extension.js](https://github.com/logisbase/vroom/blob/main/addon/extension.js)           |
| Valhalla   | Registers settings components into Fleet-Ops routing slots                                       | [valhalla/addon/extension.js](https://github.com/logisbase/valhalla/blob/main/addon/extension.js)     |
| Ledger     | Registers an order-details tab into Fleet-Ops                                                    | [ledger/addon/extension.js](https://github.com/logisbase/ledger/blob/main/addon/extension.js)         |
...
| File                                                                                                                                           | Description                    |
| :--------------------------------------------------------------------------------------------------------------------------------------------- | :----------------------------- |
| [`addon/services/universe/registry-service.js`](https://github.com/logisbase/ember-core/blob/main/addon/services/universe/registry-service.js) | RegistryService implementation |
| [`addon/contracts/extension-component.js`](https://github.com/logisbase/ember-core/blob/main/addon/contracts/extension-component.js)           | `ExtensionComponent`           |
| [`addon/contracts/registry.js`](https://github.com/logisbase/ember-core/blob/main/addon/contracts/registry.js)                                 | `Registry`                     |
