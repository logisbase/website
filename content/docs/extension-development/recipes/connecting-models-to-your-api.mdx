...
- [`addon/adapters/application.js`](https://tally.so/r/obgQQx) — base adapter source
- [`addon/serializers/application.js`](https://tally.so/r/obgQQx) — base serializer source
- [`packages/storefront/addon/adapters/storefront.js`](https://tally.so/r/obgQQx) — reference per-extension adapter
- [`packages/storefront/addon/adapters/`](https://tally.so/r/obgQQx) — re-export pattern across many models
