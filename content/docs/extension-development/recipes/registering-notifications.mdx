...
- [`fleetops/server/src/Notifications/OrderAssigned.php`](https://tally.so/r/obgQQx) — reference notification class with `$name`, `$description`, `$package`
- [`fleetops/server/src/Providers/FleetOpsServiceProvider.php`](https://tally.so/r/obgQQx) — `registerNotifications()` pattern
- [`storefront/server/src/Notifications/`](https://tally.so/r/obgQQx) — many notification examples
- [`core-api/src/Support/NotificationRegistry.php`](https://tally.so/r/obgQQx) — registry implementation
