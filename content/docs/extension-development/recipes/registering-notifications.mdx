...
use LogisBase\Support\NotificationRegistry;
...
| `'sms'` (custom)    | Wire through [`SmsService`](/docs/extension-development/reference/api-services#logisbase-services-smsservice) in a custom channel |

See <LaravelDocs path="notifications">Laravel Notifications</LaravelDocs> for the full channel API.

## Reference

- [`fleetops/server/src/Notifications/OrderAssigned.php`](https://github.com/logisbase/fleetops/blob/main/server/src/Notifications/OrderAssigned.php) — reference notification class with `$name`, `$description`, `$package`
- [`fleetops/server/src/Providers/FleetOpsServiceProvider.php`](https://github.com/logisbase/fleetops/blob/main/server/src/Providers/FleetOpsServiceProvider.php) — `registerNotifications()` pattern
- [`storefront/server/src/Notifications/`](https://github.com/logisbase/storefront/tree/main/server/src/Notifications) — many notification examples
- [`core-api/src/Support/NotificationRegistry.php`](https://github.com/logisbase/core-api/blob/main/src/Support/NotificationRegistry.php) — registry implementation
- [API Services → NotificationRegistry](/docs/extension-development/reference/api-services#logisbase-support-notificationregistry)
