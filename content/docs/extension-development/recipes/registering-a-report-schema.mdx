...
Create a class that implements `LogisBase\Support\Reporting\Contracts\ReportSchema`:
...
use LogisBase\Support\Reporting\Contracts\ReportSchema;
use LogisBase\Support\Reporting\ReportSchemaRegistry;
use LogisBase\Support\Reporting\Schema\Column;
use LogisBase\Support\Reporting\Schema\Relationship;
use LogisBase\Support\Reporting\Schema\Table;
...
- [`fleetops/server/src/Support/Reporting/FleetOpsReportSchema.php`](https://github.com/logisbase/fleetops/blob/main/server/src/Support/Reporting/FleetOpsReportSchema.php) — full reference implementation, including 7 tables with relationships and transformers
- [`fleetops/server/src/Providers/ReportSchemaServiceProvider.php`](https://github.com/logisbase/fleetops/blob/main/server/src/Providers/ReportSchemaServiceProvider.php) — minimal provider
- [`core-api/src/Support/Reporting/`](https://github.com/logisbase/core-api/tree/main/src/Support/Reporting) — `Table`, `Column`, `Relationship` classes and the registry itself
