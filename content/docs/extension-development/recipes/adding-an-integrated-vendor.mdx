...
use LogisBase\FleetOps\Models\IntegratedVendor;
...
class AcmeDispatch
{
    ...
    public function cancelFromLogisBaseOrder(): void
    {
...
use LogisBase\FleetOps\Support\IntegratedVendors;
...
public function boot()
{
    ...
    IntegratedVendors::$supported[] = [
        ...
        'callbacks' => [
            ...
            'onCanceled' => ['cancelFromLogisBaseOrder' => []],
        ],
    ];
}
```
...
- [`fleetops/server/src/Support/IntegratedVendors.php`](https://github.com/logisbase/fleetops/blob/main/server/src/Support/IntegratedVendors.php) — descriptor registry + `bridgeFromIntegratedVendor` helper
- [`fleetops/server/src/Integrations/Lalamove/`](https://github.com/logisbase/fleetops/tree/main/server/src/Integrations/Lalamove) — full reference bridge with service types, market codes, and webhook handling
- [`fleetops/server/src/Models/IntegratedVendor.php`](https://github.com/logisbase/fleetops/blob/main/server/src/Models/IntegratedVendor.php) — the persisted model
