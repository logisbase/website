...
- [`fleetops/server/src/Support/IntegratedVendors.php`](https://tally.so/r/obgQQx) — descriptor registry + `bridgeFromIntegratedVendor` helper
- [`fleetops/server/src/Integrations/Lalamove/`](https://tally.so/r/obgQQx) — full reference bridge with service types, market codes, and webhook handling
- [`fleetops/server/src/Models/IntegratedVendor.php`](https://tally.so/r/obgQQx) — the persisted model
