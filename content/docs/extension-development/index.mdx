...
description: Build custom extensions for LogisBase. Add features, integrations, and entire modules using the Universe service architecture in @logisbase/ember-core and the Laravel package layer in logisbase/core-api.
---
...
<Callout type="info">
  **Two halves, one extension.** A LogisBase extension is a single repository
  ...
  together. See
  [Architecture](/docs/extension-development/architecture/overview).
</Callout>
...
<div className="not-prose mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
  <Card>
    <CardHeader>
      ...
      <CardDescription className="text-xs">
        Scaffold a new extension, link it into your local LogisBase, and run it
        for the first time.
      </CardDescription>
    </CardHeader>
    <CardContent>
  ...
  <Card>
    <CardHeader>
      ...
      <CardDescription className="text-xs">
        How an extension is structured — addon + server, manifest, and engine
        loading.
      </CardDescription>
    </CardHeader>
    <CardContent>
  ...
  <Card>
    ...
    <CardContent>
      <a
        href="/docs/extension-development/frontend/routing"
        className="text-primary text-sm hover:underline"
      >
        Frontend →
      </a>
  ...
  <Card>
    <CardHeader>
      ...
      <CardDescription className="text-xs">
        Service providers, routes, controllers, models, migrations, expansions,
        and observers.
      </CardDescription>
    </CardHeader>
    <CardContent>
      <a
        href="/docs/extension-development/backend/service-provider"
        className="text-primary text-sm hover:underline"
      >
        Backend →
      </a>
  ...
  <Card>
    <CardHeader>
      ...
      <CardDescription className="text-xs">
        Bundle, version, and publish your extension to the LogisBase Extension
        Registry.
      </CardDescription>
    </CardHeader>
    <CardContent>
      <a
        href="/docs/extension-development/publishing/overview"
        className="text-primary text-sm hover:underline"
      >
        Publishing →
      </a>
...
If this is your first extension, follow the [Quickstart](/docs/extension-development/getting-started/quickstart) — it walks through scaffolding, linking to a running LogisBase, and the first round-trip to the API.
