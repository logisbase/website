...
[`logisbase/ledger`](https://tally.so/r/obgQQx) is a representative full-featured extension — both halves, observers, expansions, dashboard, settings menu items, routes, models, migrations. Read it alongside this section.

## Source Reference

| File                                                                                 | Description             |
| :----------------------------------------------------------------------------------- | :---------------------- |
| [Ledger `extension.json`](https://tally.so/r/obgQQx)                                 | Real manifest           |
| [Ledger `addon/extension.js`](https://tally.so/r/obgQQx)                             | Real `setupExtension`   |
| [Ledger `addon/engine.js`](https://tally.so/r/obgQQx)                                | Real engine declaration |
| [Ledger `server/src/Providers/LedgerServiceProvider.php`](https://tally.so/r/obgQQx) | Real provider           |
| [Ledger `server/src/routes.php`](https://tally.so/r/obgQQx)                          | Real routes file        |
