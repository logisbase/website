...
[`addon/services/fetch.js`](https://github.com/logisbase/ember-core/blob/main/addon/services/fetch.js)

---

## `store`

Standard <EmberDataApi path="modules/@ember-data%2Fstore">Ember Data Store</EmberDataApi>, pre-configured to talk to the LogisBase API. Use it for resources you've defined as Ember Data models in your engine.
...
The application adapter ([`addon/adapters/application.js`](https://github.com/logisbase/ember-core/blob/main/addon/adapters/application.js)) handles auth + the API base URL. To point models at your extension's API, extend it with your namespace:

```js
// addon/adapters/my-extension.js
import ApplicationAdapter from '@logisbase/ember-core/adapters/application';
...
[`addon/services/current-user.js`](https://github.com/logisbase/ember-core/blob/main/addon/services/current-user.js)

---

## `session`

Standard `ember-simple-auth` session. The LogisBase authenticator stores the bearer token and user UUID under `session.data.authenticated`.
...
await this.session.authenticate('authenticator:logisbase', { email, password });
this.session.requireAuthentication(transition, 'auth.login');
```

### Source

[`addon/services/session.js`](https://github.com/logisbase/ember-core/blob/main/addon/services/session.js) + ember-simple-auth's <EmberApi path="classes/SessionService">SessionService</EmberApi>.
...
Toast notifications, plus a LogisBase-specific `serverError` helper. Built on `ember-cli-notifications`.
...
[`addon/services/notifications.js`](https://github.com/logisbase/ember-core/blob/main/addon/services/notifications.js)

---

## `socket`

WebSocket client (SocketCluster) for real-time pub/sub. Channel names are arbitrary — LogisBase uses `company.{uuid}`, `user.{uuid}`, and `api-credential.{uuid}` for the standard event streams.
...
[`addon/services/socket.js`](https://github.com/logisbase/ember-core/blob/main/addon/services/socket.js) — see also <SocketClusterDocs>SocketCluster client docs</SocketClusterDocs>.
...
[`addon/services/crud.js`](https://github.com/logisbase/ember-core/blob/main/addon/services/crud.js)
...
[`addon/services/chat.js`](https://github.com/logisbase/ember-core/blob/main/addon/services/chat.js)
...
[`addon/services/theme.js`](https://github.com/logisbase/ember-core/blob/main/addon/services/theme.js)
...
[`addon/services/app-cache.js`](https://github.com/logisbase/ember-core/blob/main/addon/services/app-cache.js)
...
[`addon/services/language.js`](https://github.com/logisbase/ember-core/blob/main/addon/services/language.js)
...
import ResourceActionService from '@logisbase/ember-core/services/resource-action';
...
[`addon/services/resource-action.js`](https://github.com/logisbase/ember-core/blob/main/addon/services/resource-action.js)
...
- <EmberApi path="classes/Service">Ember Service base class</EmberApi> on the
  upstream Ember API docs
- <EmberDataApi path="modules/@ember-data%2Fstore">
    Ember Data Store
  </EmberDataApi>
  — the `store` service
...
| File                                                                                                       | Description                                  |
| :--------------------------------------------------------------------------------------------------------- | :------------------------------------------- |
| [`addon/exports/services.js`](https://github.com/logisbase/ember-core/blob/main/addon/exports/services.js) | Canonical service injection list for engines |
| [`addon/services/`](https://github.com/logisbase/ember-core/tree/main/addon/services)                      | All host services                            |
