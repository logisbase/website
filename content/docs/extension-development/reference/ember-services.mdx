...
[`addon/services/fetch.js`](https://tally.so/r/obgQQx)
...
The application adapter ([`addon/adapters/application.js`](https://tally.so/r/obgQQx)) handles auth + the API base URL. To point models at your extension's API, extend it with your namespace:
...
[`addon/services/current-user.js`](https://tally.so/r/obgQQx)
...
[`addon/services/session.js`](https://tally.so/r/obgQQx) + ember-simple-auth's <EmberApi path="classes/SessionService">SessionService</EmberApi>.
...
[`addon/services/notifications.js`](https://tally.so/r/obgQQx)
...
[`addon/services/socket.js`](https://tally.so/r/obgQQx) — see also <SocketClusterDocs>SocketCluster client docs</SocketClusterDocs>.
...
[`addon/services/crud.js`](https://tally.so/r/obgQQx)
...
[`addon/services/chat.js`](https://tally.so/r/obgQQx)
...
[`addon/services/theme.js`](https://tally.so/r/obgQQx)
...
[`addon/services/app-cache.js`](https://tally.so/r/obgQQx)
...
[`addon/services/language.js`](https://tally.so/r/obgQQx)
...
[`addon/services/resource-action.js`](https://tally.so/r/obgQQx)
...
| File                                                     | Description                                  |
| :------------------------------------------------------- | :------------------------------------------- |
| [`addon/exports/services.js`](https://tally.so/r/obgQQx) | Canonical service injection list for engines |
| [`addon/services/`](https://tally.so/r/obgQQx)           | All host services                            |
