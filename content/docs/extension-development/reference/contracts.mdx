...
| File                                                                  | Description          |
| :-------------------------------------------------------------------- | :------------------- |
| [`addon/contracts/index.js`](https://tally.so/r/obgQQx)               | Public exports       |
| [`addon/contracts/menu-item.js`](https://tally.so/r/obgQQx)           | `MenuItem`           |
| [`addon/contracts/menu-panel.js`](https://tally.so/r/obgQQx)          | `MenuPanel`          |
| [`addon/contracts/widget.js`](https://tally.so/r/obgQQx)              | `Widget`             |
| [`addon/contracts/hook.js`](https://tally.so/r/obgQQx)                | `Hook`               |
...
| [`addon/contracts/template-helper.js`](https://tally.so/r/obgQQx)     | `TemplateHelper`     |
| [`addon/contracts/base-contract.js`](https://tally.so/r/obgQQx)       | `BaseContract`       |
