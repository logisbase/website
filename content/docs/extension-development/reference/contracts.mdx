---
title: Contracts
description: Reference for every contract in @logisbase/ember-core/contracts — MenuItem, MenuPanel, Widget, Hook, ExtensionComponent, Registry, TemplateHelper, BaseContract.
---

# Contracts

The **contracts** in `@logisbase/ember-core/contracts` are the canonical shapes you pass to the Universe sub-services. Use them — they validate inputs, normalize defaults, and serialize correctly when stored in registries.
...
```js
import { MenuPanel, MenuItem } from '@logisbase/ember-core/contracts';
...
| :----------------- | :---------------------------------------------- |
| `engine`           | Engine name (`'@logisbase/storefront-engine'`)  |
...
| File                                                                                                                                 | Description          |
| :----------------------------------------------------------------------------------------------------------------------------------- | :------------------- |
| [`addon/contracts/index.js`](https://github.com/logisbase/ember-core/blob/main/addon/contracts/index.js)                             | Public exports       |
| [`addon/contracts/menu-item.js`](https://github.com/logisbase/ember-core/blob/main/addon/contracts/menu-item.js)                     | `MenuItem`           |
| [`addon/contracts/menu-panel.js`](https://github.com/logisbase/ember-core/blob/main/addon/contracts/menu-panel.js)                   | `MenuPanel`          |
| [`addon/contracts/widget.js`](https://github.com/logisbase/ember-core/blob/main/addon/contracts/widget.js)                           | `Widget`             |
| [`addon/contracts/hook.js`](https://github.com/logisbase/ember-core/blob/main/addon/contracts/hook.js)                               | `Hook`               |
...
| [`addon/contracts/template-helper.js`](https://github.com/logisbase/ember-core/blob/main/addon/contracts/template-helper.js)         | `TemplateHelper`     |
| [`addon/contracts/base-contract.js`](https://github.com/logisbase/ember-core/blob/main/addon/contracts/base-contract.js)             | `BaseContract`       |
