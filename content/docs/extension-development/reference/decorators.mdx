...
Real example: [`packages/fleetops/addon/components/order-tracking-lookup.js:21`](https://tally.so/r/obgQQx).
...
Real example: [`packages/dev-engine/addon/controllers/webhooks/view.js:25`](https://tally.so/r/obgQQx).
...
| File                                                                | Description                        |
| :------------------------------------------------------------------ | :--------------------------------- |
| [`addon/decorators/engine-service.js`](https://tally.so/r/obgQQx)   | Cross-engine service decorator     |
| [`addon/decorators/from-store.js`](https://tally.so/r/obgQQx)       | Lazy `store.query` decorator       |
| [`addon/decorators/fetch-from.js`](https://tally.so/r/obgQQx)       | Lazy `fetch.get` decorator         |
| [`addon/utils/inject-engine-service.js`](https://tally.so/r/obgQQx) | Underlying engine-service resolver |
