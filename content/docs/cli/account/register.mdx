---
title: Register
description: 'Create a LogisBase Extension Registry developer account using `flb register` so you can publish your own extensions.'
---

# `flb register`

Create a developer account on the LogisBase Extension Registry. You need an account to publish extensions — managing or installing extensions does **not** require an account.
