...
| :-------------- | :------ | :----------------------------------------------------------------------------------- |
| **OSRM**        | ✓       | Source-available, self-hosted. The default for both Cloud and self-hosted LogisBase. |
| **Google Maps** |         | Traffic-aware routing using Google's directions API.                                 |
| **Valhalla**    |         | Source-available routing engine — alternative to OSRM with multi-modal support.      |
