...
**Navigator** is the React Native mobile app drivers use to receive dispatched orders, navigate routes, fire activity steps, capture proof of delivery, report issues, and submit fuel reports. It is source-available — the source lives at [github.com/logisbase/navigator-app](https://github.com/logisbase/navigator-app) — and ships as both an iOS and Android app.
