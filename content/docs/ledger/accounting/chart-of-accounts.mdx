...
When your LogisBase company is created, Ledger seeds the following accounts. They are flagged `is_system_account: true` and protected from deletion.
...
<Steps>
  ...
  <Step>Click **New Account**.</Step>
  <Step>
    Enter the **Name**, **Code** (free-form alphanumeric), and select the
    **Type**.
  </Step>
  <Step>Set the **Currency** (defaults to your company's base currency).</Step>
  <Step>
