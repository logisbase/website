      ...
      <div className="flex max-w-lg flex-col gap-15 text-balance">
        ...
        <div className="space-y-7.5">
          <p className="text-muted-foreground text-lg leading-snug">
            LogisBase is built to sit inside real-world operations, not
            greenfield demos. Connect your ERP, accounting, communications,
            analytics, cloud infrastructure, and custom apps without rebuilding
