    ...
    <section className="section-padding container">
      ...
      >
        ...
        <div className="relative z-1 flex flex-col gap-4">
          ...
          <p className="text-muted-foreground mt-2 max-w-xl text-lg leading-snug">
            Design custom order flows, activity triggers, and business logic
            that match exactly how your operations work — not how your vendor
            thinks they should. From trucking to healthcare, food delivery to
            field service, LogisBase adapts to your industry without a single
            line of code.
          </p>
        </div>
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  card.position,
                  card.isProcessing
                    ? 'after:bg-accent rounded-full via-[var(--chart-2)] before:absolute before:inset-0 before:rounded-full before:bg-gradient-to-r before:from-[var(--chart-1)] before:to-[var(--chart-3)] after:absolute after:inset-[1px] after:rounded-full'
                    : `bg-gradient-to-br ${card.bgColor} rounded-lg border border-white/10 shadow-xl`,
                )}
              >
                {card.isProcessing ? (
                  ...
                  <>
                    <div className="flex items-center gap-2">
                      ...
                      <h3 className="text-foreground text-sm font-bold lg:text-base">
                        {card.title}
                      </h3>
                    </div>
                    {card.subtitle && (
      ...
      <div className="mx-auto max-w-5xl pt-16">
        ...
        <div className="mb-12 grid grid-cols-1 gap-6 md:grid-cols-3">
          <div className="flex flex-col items-center gap-4 rounded-xl border-2 border-blue-500/20 bg-gradient-to-br from-blue-500/10 to-cyan-500/10 p-6 text-center shadow-lg transition-all hover:border-blue-500/40">
            <div className="flex h-14 w-14 items-center justify-center rounded-xl border border-blue-500/30 bg-blue-500/20">
              <FileText className="h-7 w-7 text-blue-500" />
            </div>
            <div>
              <h3 className="mb-2 text-lg font-bold">Custom Fields</h3>
          ...
          <div className="flex flex-col items-center gap-4 rounded-xl border-2 border-purple-500/20 bg-gradient-to-br from-purple-500/10 to-pink-500/10 p-6 text-center shadow-lg transition-all hover:border-purple-500/40">
            <div className="flex h-14 w-14 items-center justify-center rounded-xl border border-purple-500/30 bg-purple-500/20">
              <GitBranch className="h-7 w-7 text-purple-500" />
            </div>
            <div>
              <h3 className="mb-2 text-lg font-bold">Logic & Triggers</h3>
              <p className="text-muted-foreground text-sm leading-relaxed">
          ...
          <div className="flex flex-col items-center gap-4 rounded-xl border-2 border-emerald-500/20 bg-gradient-to-br from-emerald-500/10 to-green-500/10 p-6 text-center shadow-lg transition-all hover:border-emerald-500/40">
            <div className="flex h-14 w-14 items-center justify-center rounded-xl border border-emerald-500/30 bg-emerald-500/20">
              <Workflow className="h-7 w-7 text-emerald-500" />
            </div>
            <div>
              <h3 className="mb-2 text-lg font-bold">Activity Flows</h3>
              <p className="text-muted-foreground text-sm leading-relaxed">
        ...
        <div className="flex justify-center">
          <Button
            className="rounded-lg bg-[#4A90E2] px-10 py-6 text-lg font-semibold text-white shadow-xl transition-all hover:scale-105 hover:bg-[#3D7DC2] hover:shadow-2xl"
            asChild
          >
            <a href="/order-config">See Configuration Examples</a>
          </Button>
        </div>
      </div>
    </section>
