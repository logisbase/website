  ...
  return (
    <section className="section-padding container">
      ...
      <p className="text-muted-foreground leading-snug md:text-lg lg:text-xl">
        ...
        Whether you&apos;re scripting simple file routines or building
        multi-step, logic-heavy flows, Plasma puts you in the driver’s seat.
        Visual when it helps. Text-based when it matters.
        <br />
        <br />
