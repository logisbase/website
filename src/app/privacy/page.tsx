...
export const metadata: Metadata = {
  title: 'Privacy Policy | LogisBase',
  description:
    'LogisBase Privacy Policy — how we collect, use, and protect your data when using LogisBase Cloud and SaaS services.',
  alternates: { canonical: 'https://logisbase.com/privacy' },
  openGraph: {
    title: 'Privacy Policy | LogisBase',
    description: 'How LogisBase collects, uses, and protects your data.',
  },
  twitter: {
        ...
        <div className="space-y-10">
          <section id="privacy-1">
            ...
            <p className="text-muted-foreground mb-4 text-sm leading-relaxed">
              ...
              company name, phone number, and billing information. This
              information is necessary to provide the Service and process
              payments.
            </p>

            <h3 className="mb-2 font-semibold">Usage and Platform Data</h3>
            <p className="text-muted-foreground mb-4 text-sm leading-relaxed">
              We collect data about how you use the Service, including log data
              (IP addresses, browser type, pages visited, timestamps), feature
              usage, API calls, and Resource Unit consumption. This helps us
              improve the Service and detect issues.
            </p>

            <h3 className="mb-2 font-semibold">Customer Data</h3>
            <p className="text-muted-foreground mb-4 text-sm leading-relaxed">
              We process data that you submit to the Service in the course of
              your operations — including order details, driver information,
              vehicle data, customer contacts, and delivery records. This data
              belongs to you and is processed on your behalf.
            </p>

            <h3 className="mb-2 font-semibold">Communications Data</h3>
            <p className="text-muted-foreground text-sm leading-relaxed">
              If you contact us via email, chat, or our support system, we
              retain records of those communications to help resolve your
              enquiries and improve our support.
            </p>
          </section>
          ...
          <section id="privacy-2">
            ...
            <ul className="text-muted-foreground list-inside list-disc space-y-2 text-sm">
              ...
              <li>
                Send product updates, security notices, and administrative
                messages.
              </li>
              <li>
              ...
              <li>
                Send marketing communications where you have given consent (you
          ...
          <section id="privacy-3">
            ...
            <p className="text-muted-foreground mb-3 leading-relaxed">
              ...
              United Kingdom, our legal bases for processing your personal data
              are:
            </p>
            <ul className="text-muted-foreground list-inside list-disc space-y-2 text-sm">
              <li>
                <strong>Contract performance</strong> — processing necessary to
                provide the Service under our agreement with you.
              </li>
              <li>
                <strong>Legitimate interests</strong> — improving the Service,
                preventing fraud, and communicating about relevant updates.
              </li>
              <li>
          ...
          <section id="privacy-4">
            ...
            <ul className="text-muted-foreground list-inside list-disc space-y-2 text-sm">
              <li>
                ...
                assist us in operating the Service (e.g. cloud infrastructure
                providers, payment processors, email service providers). These
              ...
              <li>
                ...
                property, or safety of LogisBase, our customers, or the public.
              </li>
            </ul>
          </section>
          ...
          <section id="privacy-5">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              or as needed to provide the Service. After account termination, we
          ...
          <section id="privacy-6">
            ...
            <p className="text-muted-foreground mt-3 text-sm leading-relaxed">
              While we take reasonable steps to protect your data, no security
              system is impenetrable. In the event of a data breach affecting
              your personal data, we will notify you as required by applicable
              law.
            </p>
          </section>
          ...
          <section id="privacy-9">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              improve your experience, analyse traffic, and personalise content.
              You can control cookie preferences through your browser settings.
              Disabling certain cookies may affect the functionality of our
              website. We do not use cookies to track you across third-party
              websites for advertising purposes.
            </p>
            <p className="text-muted-foreground mt-4 leading-relaxed">
              We use <strong>PostHog</strong> for first-party product analytics:
              pageviews, button clicks, and aggregate usage patterns help us
              understand which parts of the site are useful and which are not.
              PostHog cookies (prefixed{' '}
              <code className="bg-muted rounded px-1 py-0.5">ph_</code>) are
              stored on the{' '}
              <code className="bg-muted rounded px-1 py-0.5">
                .logisbase.com
              </code>{' '}
              domain. We never capture form field values, and session replays
              mask all input fields by default. Visitors in the EU, EEA, UK, and
              Switzerland are asked to opt in before any data is captured. You
              can withdraw consent at any time by clearing the{' '}
              <code className="bg-muted rounded px-1 py-0.5">fb_consent</code>{' '}
              cookie or contacting us at{' '}
              <a
                href="mailto:hello@logisbase.com"
                className="text-primary underline underline-offset-4"
              >
              ...
              (Sec-GPC) signal globally.
            </p>
            <p className="text-muted-foreground mt-4 leading-relaxed">
              We also use <strong>Google Analytics 4</strong> on the marketing
              website for SEO attribution (Google Search Console) and Google Ads
              conversion tracking. GA4 cookies (
              <code className="bg-muted rounded px-1 py-0.5">_ga</code>,{' '}
              <code className="bg-muted rounded px-1 py-0.5">_ga_*</code>) are
              stored on the{' '}
              <code className="bg-muted rounded px-1 py-0.5">
                logisbase.com
              </code>{' '}
              domain. The GA4 loader script and data-collection requests are
              proxied through our own origin (
              <code className="bg-muted rounded px-1 py-0.5">/gtm/*</code> and{' '}
              <code className="bg-muted rounded px-1 py-0.5">/g/collect</code>)
              so no third-party hostnames are contacted by your browser. Google
              Analytics is governed by{' '}
              <a
              ...
              . Visitors in opt-in jurisdictions are placed under Google&rsquo;s
              Consent Mode v2 default-denied state until they accept; even after
              acceptance, IP addresses are anonymised and we only forward
              conversion events (such as trial signups and demo requests), not
              the full event firehose. GA4 is not loaded on{' '}
              <code className="bg-muted rounded px-1 py-0.5">
                console.logisbase.com
              </code>
              .
            </p>
            <p className="text-muted-foreground mt-4 leading-relaxed">
              We use <strong>Ahrefs Web Analytics</strong> to cross-reference
              site traffic with our Ahrefs SEO data (organic landing pages,
              referring domains, content performance). Ahrefs Web Analytics is{' '}
              <strong>cookieless</strong> and does not use fingerprinting or any
              cross-site identifiers — it does not set any cookies on your
              browser and does not require consent under GDPR. The script is
              served from{' '}
              <code className="bg-muted rounded px-1 py-0.5">
                analytics.ahrefs.com
              </code>
              ; only anonymous, aggregated pageview data is collected.
              Ahrefs&rsquo; processing is governed by the{' '}
              <a
          ...
          <section id="privacy-11">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              any third-party services you use in connection with LogisBase.
            </p>
          </section>
          ...
          <section id="privacy-12">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              our website at least 30 days before the changes take effect. Your
