...
function lastModifiedFor(routePath: string): Date {
  ...
  const relative =
    routePath === '/' ? 'page.tsx' : `${routePath.slice(1)}/page.tsx`;
  try {
...
const STATIC_ROUTES: StaticEntry[] = [
  ...
  {
    path: '/services/navigator-publishing',
    changeFrequency: 'monthly',
    priority: 0.8,
  },
  {
    path: '/services/storefront-publishing',
    changeFrequency: 'monthly',
    priority: 0.8,
  },
  ...
  {
    path: '/solutions/courier-services',
    changeFrequency: 'monthly',
    priority: 0.8,
  },
  {
    path: '/solutions/food-delivery',
    changeFrequency: 'monthly',
    priority: 0.8,
  },
  ...
  {
    path: '/solutions/container-operations',
    changeFrequency: 'monthly',
    priority: 0.7,
  },
  ...
  // Solutions — Use Cases
  {
    path: '/solutions/use-cases/order-management',
    changeFrequency: 'monthly',
    priority: 0.8,
  },
  {
    path: '/solutions/use-cases/fleet-management',
    changeFrequency: 'monthly',
    priority: 0.9,
  },
  {
    path: '/solutions/use-cases/last-mile-delivery',
    changeFrequency: 'monthly',
    priority: 0.9,
  },
  {
    path: '/solutions/use-cases/route-optimization',
    changeFrequency: 'monthly',
    priority: 0.8,
  },
  {
    path: '/solutions/use-cases/analytics',
    changeFrequency: 'monthly',
    priority: 0.7,
  },
  {
    path: '/solutions/use-cases/integrations',
    changeFrequency: 'monthly',
    priority: 0.7,
  },
  ...
  // Solutions — Roles
  {
    path: '/solutions/roles/fleet-managers',
    changeFrequency: 'monthly',
    priority: 0.7,
  },
  {
    path: '/solutions/roles/operations-managers',
    changeFrequency: 'monthly',
    priority: 0.7,
  },
  {
    path: '/solutions/roles/executives',
    changeFrequency: 'monthly',
    priority: 0.7,
  },
  {
    path: '/solutions/roles/developers',
    changeFrequency: 'monthly',
    priority: 0.7,
  },
  {
    path: '/solutions/roles/warehouse-managers',
    changeFrequency: 'monthly',
    priority: 0.7,
  },
  {
    path: '/solutions/roles/customer-success',
    changeFrequency: 'monthly',
    priority: 0.7,
  },
  ...
  {
    path: '/platform/developer-console',
    changeFrequency: 'monthly',
    priority: 0.7,
  },
