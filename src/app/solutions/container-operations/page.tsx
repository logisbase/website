...
export const metadata: Metadata = {
  alternates: {
    canonical: 'https://logisbase.com/solutions/container-operations',
  },
  title: 'Container & Port Logistics Software | LogisBase',
  description:
    'Full container visibility from port to door. Track containers across multi-modal journeys, manage documentation, coordinate yard operations, and integrate with existing port systems.',
  keywords: [
  ...
  openGraph: {
    title: 'Container Operations Logistics | LogisBase',
    description:
      'Full container visibility from port to door — tracking, documentation, and yard operations in one platform.',
  },
  twitter: {
    ...
    <SolutionPageLayout
      ...
      title={
        <>
          Full Visibility.
          <br />
          <span className="text-gradient">Port to Door. No Gaps.</span>
        </>
      }
      description="Container logistics is too complex for a patchwork of spreadsheets and phone calls. LogisBase gives container operators, freight forwarders, and terminal managers a unified platform for container tracking, documentation management, yard operations, and real-time stakeholder visibility — from the moment a container is loaded to final delivery."
      stats={[
        { value: '100%', label: 'Container lifecycle traceability' },
        { value: '35%', label: 'Reduction in manual documentation time' },
        {
          value: '2×',
          label: 'Faster gate-out processing with digital workflows',
        },
      ...
      heroScreenshotAlt="LogisBase container operations — port logistics and container tracking dashboard"
      painPoints={{
      ...
      features={[
        {
          ...
          description:
            'Track containers from port of discharge through inland transport, deconsolidation, and final delivery. Every status update, location change, and handoff is logged with timestamps and GPS data — giving you and your clients a complete, unbroken chain of custody.',
          bullets: [
        ...
        },
        {
          ...
          description:
            'Know exactly where every container is in your yard at any moment. Manage gate-in and gate-out workflows, track container positions on a yard map, and coordinate stacking and retrieval without paper tickets or radio calls.',
          bullets: [
        ...
        },
        {
          ...
          description:
            'Digitize your documentation workflow — bills of lading, delivery orders, customs declarations, and inspection certificates — and eliminate the manual errors that cause costly customs delays and demurrage charges.',
          bullets: [
        ...
        },
        {
          ...
          description:
            "Give shippers, consignees, freight brokers, and customs agents their own visibility into the containers they care about — without giving them access to operations data they shouldn't see.",
          bullets: [
        ...
        },
        {
          ...
          description:
            "Once containers clear customs and deconsolidation, LogisBase's dispatch engine assigns outbound deliveries to your own truck fleet or third-party carriers — with full tracking from depot to consignee.",
          bullets: [
        ...
        },
        {
          ...
          description:
            'Track container dwell times, identify which carriers are causing delays, and catch demurrage risk before charges accumulate. Make data-driven decisions on carrier performance and yard capacity.',
          bullets: [
      ...
      testimonial={{
        quote:
          'We went from three spreadsheets and constant phone calls to a single platform. Our documentation errors dropped to near zero and our clients stopped calling us for status updates.',
        author: 'Ahmad R.',
      ...
      faqs={[
        {
          q: 'Can LogisBase integrate with existing port management or terminal operating systems?',
        ...
        {
          q: 'Does LogisBase support multi-modal container journeys?',
        ...
        },
        {
          ...
          a: 'LogisBase tracks container dwell time against configurable free-day thresholds and triggers alerts to operations teams when a container is approaching demurrage territory.',
        },
        {
          q: 'Is the platform suitable for freight forwarders as well as terminal operators?',
          a: 'Yes. Freight forwarders use LogisBase to manage multi-client shipment visibility and documentation. Terminal operators use the yard management and gate workflow features. Both can run from the same account.',
        },
      ]}
