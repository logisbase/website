...
export const metadata: Metadata = {
  alternates: {
    canonical: 'https://logisbase.com/solutions/roles/operations-managers',
  },
  title: 'Logistics Software for Operations Managers | LogisBase',
  description:
  ...
  keywords: [
    'logistics software for operations managers',
  ...
  openGraph: {
    title: 'Logistics Software for Operations Managers | LogisBase',
    description:
      'Everything you need to run your operation in one place — live, accurate, and actionable.',
  },
  twitter: {
...
export default function OperationsManagersPage() {
  return (
    <SolutionPageLayout
      ...
      description="Operations managers are stretched across dispatch decisions, SLA monitoring, driver coordination, and performance reporting — often across multiple tools that don't talk to each other. LogisBase gives you a single operations control centre: live dispatch visibility, automated SLA alerting, exception management, and performance reporting — without the context-switching that burns your day."
      stats={[
        { value: '50%', label: 'Reduction in time spent on manual dispatch' },
        {
          value: '3×',
          label: 'Faster exception resolution with live visibility',
        },
        {
          value: '40%',
          label: 'Less time on status update requests from stakeholders',
        },
        {
          value: '98%',
          label: 'On-time SLA rate for operations running LogisBase',
        },
      ]}
      heroScreenshot="/images/screenshots/fleet-ops/fleet-ops-live-orders-panel.webp"
      heroScreenshotAlt="LogisBase operations management dashboard — live dispatch, SLA tracking, and driver overview"
      painPoints={{
      ...
      features={[
        {
          ...
          description:
            'See your entire operation in real time — every active driver, every order in progress, every vehicle on the map. Identify bottlenecks, manage driver capacity, and make dispatch decisions from a single view without calling a single driver.',
          bullets: [
        ...
        },
        {
          ...
          description:
            'LogisBase watches every active order against its committed delivery window. When an order is at risk of breaching its SLA — not when it already has — the right person gets an alert with enough time to act. You manage by exception, not by constant monitoring.',
          bullets: [
        ...
        },
        {
          ...
          description:
            "Reduce the manual load on your dispatch team without losing operational control. LogisBase's auto-assignment engine handles routine order-to-driver matching based on proximity, zone, and capacity — freeing dispatchers to focus on exceptions and priority jobs.",
          bullets: [
        ...
        },
        {
          ...
          description:
            'When something goes wrong — failed delivery, driver delay, vehicle breakdown — LogisBase surfaces the exception immediately with the context needed to act. Log resolutions, reassign orders, and track exception patterns to prevent recurrence.',
          bullets: [
        ...
        },
        {
          ...
          description:
            'Manage drivers, dispatchers, and depot staff with role-based access that gives each team member exactly the view and permissions they need. Multi-depot operations get separate views per location with consolidated reporting at management level.',
          bullets: [
        ...
        },
        {
          ...
          description:
            'End-of-day, weekly, and monthly performance reports generated automatically from your operational data — on-time rate, completion rate, cost-per-delivery, driver performance, and SLA adherence — presented in formats ready for leadership review or client delivery.',
          bullets: [
      ...
      testimonial={{
        quote:
          'I used to spend my mornings chasing status updates from drivers and dispatchers. Now I open LogisBase and I can see everything in one place. My team spends time solving problems rather than finding them.',
        author: 'Claire M.',
      ...
      faqs={[
        {
          q: 'Can LogisBase handle multi-depot operations from one console?',
        ...
        },
        {
          ...
          a: 'You define SLA windows per order type and configurable warning thresholds. When an active order hits the warning threshold, LogisBase alerts the designated escalation contact via console notification and optionally email or SMS — before the breach occurs.',
        },
        {
