...
export const metadata: Metadata = {
  alternates: {
    canonical: 'https://logisbase.com/solutions/roles/warehouse-managers',
  },
  title: 'Warehouse Management Software | LogisBase',
  description:
    'Connect your warehouse to your delivery operation with LogisBase Pallet WMS. Manage inventory, pick-and-pack workflows, and outbound dispatch from one integrated platform.',
  keywords: [
    'warehouse management software',
    'WMS for logistics',
    'inventory management platform',
    'pick and pack software',
    'warehouse to delivery integration',
    'pallet WMS',
  ],
  openGraph: {
    title: 'Warehouse Management Software | LogisBase',
    description:
      'From pick to doorstep — warehouse and delivery, unified in one platform.',
  },
  twitter: {
...
export default function WarehouseManagersPage() {
  return (
    <SolutionPageLayout
      ...
      features={[
        {
          ...
          description:
            'Track inventory in real time across locations, zones, and product variants. Every inbound receipt, outbound pick, and stock adjustment is logged automatically — maintaining an accurate count that your operations and commercial teams can trust.',
          bullets: [
          ...
          icon: Package,
          screenshot:
            '/images/screenshots/storefront/storefront-products-overview.webp',
        },
        {
          title: 'Pick-and-Pack Workflow Management',
          description:
            'Generate pick lists optimized for your warehouse layout. Pickers follow digital pick lists on mobile devices, confirming each item scanned. Packing instructions and shipping label generation happen at the pack station — ready for dispatch without a separate step.',
          bullets: [
          ...
          icon: ClipboardList,
          screenshot:
            '/images/screenshots/storefront/storefront-orders-overview.webp',
        },
        {
          title: 'Seamless Dispatch Integration with FleetOps',
          description:
            'When an order is packed and ready, LogisBase automatically creates the dispatch order in FleetOps — triggering driver assignment and route optimization without any manual intervention. The gap between warehouse and delivery is closed by design.',
          bullets: [
        ...
        },
        {
          ...
          description:
            'Manage the staging area where packed orders wait for driver pickup. Track which orders are staged, which driver is collecting, and when the vehicle departed. Generate consolidated manifests per driver run — with total order count, weight, and customer reference.',
          bullets: [
        ...
        },
        {
          ...
          description:
            'When a delivery is returned — refused at door, failed delivery, or customer return — LogisBase links the inbound return to the original order record. Warehouse receives the return with the right context, updates inventory correctly, and closes the loop on the delivery cycle.',
          bullets: [
        ...
        },
        {
          ...
          description:
            'Track the KPIs that determine whether your warehouse is running efficiently: pick accuracy, orders per hour per picker, staging dwell time, dispatch delay rate, and return processing time. Identify bottlenecks and measure the impact of process improvements.',
          bullets: [
      ...
      testimonial={{
        quote:
          "The moment we connected Pallet to FleetOps, we stopped losing time at the handoff. Orders are staged and assigned to drivers before they even arrive. We've reduced pick-to-door time by over a third and our dispatch errors have nearly disappeared.",
        author: 'Sam W.',
      ...
      faqs={[
        {
          q: "Does LogisBase's WMS work with barcode scanners?",
        ...
        },
        {
          ...
          a: 'When a pack station confirms an order is complete, LogisBase automatically creates the dispatch order in FleetOps, triggers driver assignment, and adds the order to the appropriate route — no manual intervention required.',
        },
        {
