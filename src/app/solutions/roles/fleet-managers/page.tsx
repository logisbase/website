...
export const metadata: Metadata = {
  alternates: {
    canonical: 'https://logisbase.com/solutions/roles/fleet-managers',
  },
  ...
  keywords: [
    ...
    'vehicle tracking fleet manager',
  ],
  openGraph: {
    title: 'Fleet Management Software for Fleet Managers | LogisBase',
    description:
      'Every vehicle. Every driver. Every compliance deadline. Visible and under control.',
  },
  twitter: {
...
export default function FleetManagersPage() {
  return (
    <SolutionPageLayout
      ...
      title={
        <>
          Every Vehicle Tracked.
          <br />
          <span className="text-gradient">Every Compliance Met.</span>
        </>
      }
      description="Fleet managers carry the weight of vehicle availability, maintenance schedules, driver compliance, and regulatory documentation — all while fielding calls from operations when a vehicle breaks down or a licence expires. LogisBase gives you a complete fleet management platform: real-time tracking, predictive maintenance, compliance documentation, and driver performance — everything you need to run a safe, legal, and available fleet."
      stats={[
      ...
      heroScreenshotAlt="LogisBase fleet manager dashboard — vehicle tracking, maintenance schedule, and compliance overview"
      painPoints={{
      ...
      features={[
        {
          ...
          description:
            'Know where every vehicle is at any moment — including speed, idle status, and route adherence. Set geofence alerts for depot boundaries, customer sites, and restricted zones. View trip history and replay any journey for performance review or incident investigation.',
          bullets: [
        ...
        },
        {
          ...
          description:
            'Track mileage, engine hours, and calendar intervals for every vehicle and automatically schedule maintenance before issues become failures. Driver fault reports feed directly into the maintenance queue — so nothing gets missed between formal service intervals.',
          bullets: [
        ...
        },
        {
          ...
          description:
            'Store and manage all vehicle and driver compliance documentation centrally — MOT records, insurance certificates, driver licences, tachograph calibrations, and inspection forms. Automated reminders ensure nothing expires without advance notice.',
          bullets: [
        ...
        },
        {
          ...
          description:
            'Track the driving behaviours that create safety risks and cost your fleet money: speeding, harsh braking, rapid acceleration, and excessive idling. Build driver scorecards, identify coaching opportunities, and demonstrate your safety management process to insurers.',
          bullets: [
        ...
        },
        {
          ...
          description:
            'Replace paper walk-around checks with digital inspection workflows in the Navigator app. Drivers complete pre-trip and post-trip checks on their phone — with photos of any defects — and reports feed instantly to the fleet management console.',
          bullets: [
        ...
        },
        {
          ...
          description:
            "Understand how your fleet assets are being used — and what they're costing you to run. Track utilization rate, cost-per-kilometre, and fuel efficiency per vehicle. Identify underutilized assets that could be redeployed or disposed of to reduce your operating cost.",
          bullets: [
      ...
      testimonial={{
        quote:
          "Before LogisBase, I had a spreadsheet for maintenance dates, a folder for compliance docs, and a whiteboard for vehicle availability. Now I have one platform that does all of it. I haven't had an unplanned breakdown in four months.",
        author: 'Neil B.',
        role: 'Fleet Manager',
      ...
      faqs={[
        {
          q: 'Does LogisBase integrate with existing GPS trackers on our vehicles?',
          a: 'Yes. LogisBase integrates with GPS tracking hardware via API to ingest vehicle telemetry data — including position, speed, and ignition status — into the live map and analytics.',
        },
        {
        ...
        },
        {
          ...
          a: 'Every compliance document stored in LogisBase has an expiry date. Automated reminders are sent to the fleet manager and optionally the driver at configurable intervals before expiry.',
        },
        {
