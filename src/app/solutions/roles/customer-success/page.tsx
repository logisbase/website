...
export const metadata: Metadata = {
  alternates: {
    canonical: 'https://logisbase.com/solutions/roles/customer-success',
  },
  title: 'Customer Support Tools for Logistics | LogisBase',
  description:
  ...
  keywords: [
    'customer support logistics software',
    'delivery tracking for support teams',
    'order visibility customer service',
  ...
  openGraph: {
    title: 'Customer Support Tools for Logistics | LogisBase',
    description:
      'Resolve customer delivery queries in seconds. Every answer is already in the platform.',
  },
  twitter: {
    ...
    <SolutionPageLayout
      ...
      title={
        <>
          ...
          <br />
          <span className="text-gradient">Answered in Seconds.</span>
        </>
      }
      description="Customer success teams spend enormous amounts of time on one question: 'Where is my delivery?' Not because the information doesn't exist — but because it's buried in systems your support team can't access, or spread across tools that don't surface the right data quickly. LogisBase gives customer-facing teams real-time order visibility, instant POD retrieval, and the proactive notification tools that stop queries before they're even raised."
      stats={[
        { value: '60%', label: 'Reduction in inbound delivery status calls' },
        {
          value: '<30s',
          label: 'Average time to answer a delivery query with LogisBase',
        },
        {
          value: '40%',
          label: 'Fewer escalations when customers have live tracking access',
        },
        {
          value: '4.8/5',
          label: 'Average customer satisfaction score with live tracking',
        },
      ]}
      heroScreenshot="/images/screenshots/fleet-ops/fleet-ops-live-orders-panel.webp"
      heroScreenshotAlt="LogisBase customer success view — order detail, live tracking, and POD retrieval"
      painPoints={{
      ...
      features={[
        {
          ...
          description:
            "Customer success teams get a dedicated view of order status that's always current — no refresh needed, no escalation to operations. Search by order number, customer name, or reference. See the current status, driver assignment, ETA, and every status event in the order's history.",
          bullets: [
          ...
          icon: MapPin,
          screenshot:
            '/images/screenshots/fleet-ops/fleet-ops-orders-kanban.webp',
        },
        {
          title: 'Live Tracking Links',
          description:
            "Every order has a live customer tracking link — shareable in seconds. When a customer calls asking where their delivery is, paste them the link. They see the driver's real position, an accurate ETA, and the delivery history. Query resolved. Call ended.",
          bullets: [
        ...
        },
        {
          ...
          description:
            "When a customer disputes a delivery — claims it wasn't delivered, was left in the wrong place, or was damaged — support teams retrieve the timestamped, GPS-anchored POD record in seconds. Signature, photo, and delivery notes are all attached to the order.",
          bullets: [
        ...
        },
        {
          ...
          description:
            "The best customer query is the one that's never raised. LogisBase automatically notifies customers at every order milestone — dispatched, out for delivery, arriving soon, delivered — via SMS, email, or push. Customers who know what's happening don't call your support team.",
          bullets: [
        ...
        },
        {
          ...
          description:
            "Give your customers a self-service portal to track their orders, download delivery records, and initiate returns — without contacting support. Customers who can help themselves don't need to be helped. Your support team's time is freed for the queries that actually require a human.",
          bullets: [
        ...
        },
        {
          ...
          description:
            'Track the customer-facing metrics that matter: on-time delivery rate, NPS scores, delivery completion rates, and support query volume by delivery issue type. Identify which delivery failures generate the most customer friction and fix them at the source.',
          bullets: [
      ...
      testimonial={{
        quote:
          'Our delivery query volume dropped 55% in the first two months after we enabled live tracking notifications. The queries we do still get are resolved in under a minute because the answer is right there in the order record.',
        author: 'Sophie K.',
      ...
      faqs={[
        ...
        },
        {
          ...
          a: 'Yes. The customer portal supports return request initiation, which creates a reverse dispatch order in LogisBase and notifies your operations team — without the customer needing to contact support.',
        },
      ]}
