...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Courier & Parcel Services Software | LogisBase',
    description:
      'Maximize first-attempt delivery rates and scale your courier business with LogisBase.',
  },
  twitter: {
    card: 'summary_large_image',
    title: `Courier & Parcel Services Software | LogisBase`,
    description: `Maximize first-attempt delivery rates and scale your courier business with LogisBase.`,
  },
};
...
export default function CourierServicesPage() {
  return (
    <SolutionPageLayout
      ...
      heroScreenshotAlt="LogisBase courier operations — parcel tracking and route management"
      painPoints={{
      ...
      features={[
        {
          ...
          description:
            'LogisBase clusters deliveries by proximity and calculates the highest-density routes to maximize parcel count per driver per shift. Cover more ground, use less fuel, and hit more time windows — without adding drivers.',
          bullets: [
        ...
        },
        {
          ...
          description:
            'The single biggest driver of first-attempt success is a customer who knows their parcel is coming. LogisBase sends automated SMS, push, and email alerts including a precise arrival window — so customers are home when you knock.',
          bullets: [
        ...
        },
        {
          ...
          description:
            'Eliminate POD disputes permanently. Drivers capture signatures, photos, barcodes, and GPS-stamped delivery evidence in the Navigator app. Every delivery is legally defensible and accessible in the console within seconds of completion.',
          bullets: [
        ...
        },
        {
          ...
          description:
            'Give your business clients a branded tracking portal for their end customers. Every parcel gets a unique tracking reference. Senders monitor their batch. Recipients follow their parcel in real-time.',
          bullets: [
        ...
        },
        {
          ...
          description:
            "Know which drivers are hitting target parcel counts, which are running behind, and what's causing exceptions. Identify systemic route problems before they compound across your fleet.",
          bullets: [
        ...
        },
        {
          ...
          description:
            'Automate what happens when a delivery fails. Configure re-attempt rules, safe-place delivery, neighbour delivery, and collection point redirection — all without manual dispatcher intervention.',
          bullets: [
      ...
      testimonial={{
        quote:
          'Our first-attempt delivery rate jumped from 78% to 94% in 60 days. The proactive customer notifications alone paid for the platform many times over.',
        author: 'Daniel K.',
      ...
      faqs={[
        {
          q: 'Can LogisBase handle high parcel volumes — tens of thousands per day?',
          a: 'Yes. LogisBase scales horizontally and is built for high-volume operations. The API-first architecture allows real-time batch parcel import and automated dispatch at any volume.',
        },
        {
        ...
        {
          q: 'Does LogisBase support multiple depot locations?',
