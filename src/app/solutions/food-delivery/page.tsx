...
export const metadata: Metadata = {
  alternates: { canonical: 'https://logisbase.com/solutions/food-delivery' },
  title: 'Food & Grocery Delivery Management Software | LogisBase',
  description:
    'Power on-demand food and grocery delivery with real-time dispatch, live customer tracking, and automated notifications. Built for speed, scale, and customer satisfaction.',
  keywords: [
  ...
  openGraph: {
    title: 'Food & Grocery Delivery Software | LogisBase',
    description:
      'Deliver faster, reduce failed orders, and keep customers coming back with LogisBase.',
  },
  twitter: {
    card: 'summary_large_image',
    title: `Food & Grocery Delivery Software | LogisBase`,
    description: `Deliver faster, reduce failed orders, and keep customers coming back with LogisBase.`,
  },
};
    ...
    <SolutionPageLayout
      ...
      title={
        <>
          Deliver Faster.
          <br />
          <span className="text-gradient">Keep Customers Coming Back.</span>
        </>
      }
      description="Every minute a hot order sits unassigned kills your rating. LogisBase powers on-demand food and grocery delivery with intelligent auto-dispatch, real-time driver tracking, live customer notifications, and the analytics to keep every order — and every margin — on track."
      stats={[
      ...
      heroScreenshotAlt="LogisBase live dispatch board for food delivery operations"
      painPoints={{
      ...
      features={[
        {
          ...
          description:
            'Every active order and driver is live on a map. Dispatchers see driver positions, order statuses, and ETAs simultaneously. The moment an order is dispatched, customers receive a live tracking link — no app download needed.',
          bullets: [
        ...
        },
        {
          ...
          description:
            'Stop manually matching orders to drivers. LogisBase automatically assigns incoming orders to the nearest available driver based on live location, delivery zone, and current workload. Process hundreds of orders per hour without adding headcount.',
          bullets: [
        ...
        },
        {
          ...
          description:
            'Proactive updates at every milestone — confirmed, preparing, picked up, en route, delivered. Customers who can track their order are 4× less likely to call support and 2× more likely to reorder.',
          bullets: [
          ...
          icon: Bell,
          screenshot:
            '/images/screenshots/storefront/storefront-push-notifications.webp',
        },
        {
          title: 'Driver Performance & Ratings',
          description:
            'Know exactly which drivers are delivering excellence and which are dragging your rating down. Track on-time rate, average delivery time, and customer scores per driver — and act on the data before it becomes a review problem.',
          bullets: [
        ...
        },
        {
          ...
          description:
            'Understand which delivery zones are most profitable, which time slots drive the most volume, and where your SLAs are breaking. Stop expanding blindly — grow the markets that actually make money.',
          bullets: [
        ...
        },
        {
          ...
          description:
            'LogisBase Storefront connects your product catalogue, checkout, and delivery dispatch in one system. Orders flow directly from customer purchase to driver assignment — with zero manual data entry and a branded customer experience.',
          bullets: [
            'Headless storefront API for custom apps and websites',
            'Direct integration with LogisBase dispatch — no middleware',
            'Customer accounts, order history, and reorder functionality',
          ],
          icon: ShoppingCart,
          screenshot:
            '/images/screenshots/storefront/storefront-dashboard.webp',
        },
      ]}
      capabilities={[
      ...
      testimonial={{
        quote:
          'We went from 45-minute average dispatch times to under 8 minutes after switching to LogisBase. Customer satisfaction jumped from 3.9 to 4.8 stars within two months.',
        author: 'Priya M.',
        role: 'COO',
      ...
      faqs={[
        {
          q: 'Can LogisBase handle high order volumes during peak hours?',
          a: 'Yes. The automated dispatch engine processes incoming orders in real-time and the platform scales horizontally. Operators handling thousands of concurrent orders during dinner peaks rely on LogisBase without degradation.',
        },
        {
        ...
        },
        {
          ...
          a: 'LogisBase has a REST API and webhooks that connect to any POS or ordering platform. The native Storefront module provides a complete ordering layer if you want everything in one system.',
        },
        {
          q: 'How does LogisBase handle failed deliveries?',
        ...
        },
        {
          ...
          a: 'Yes. LogisBase supports multi-store and multi-brand configurations under a single account, each with their own menus, zones, and driver pools.',
        },
      ]}
