...
export const metadata: Metadata = {
  alternates: { canonical: 'https://logisbase.com/solutions/healthcare' },
  title: 'Healthcare & Pharmacy Logistics Software | LogisBase',
  description:
    'HIPAA-conscious logistics management for healthcare and pharmacy delivery. Chain-of-custody tracking, temperature monitoring, priority dispatch, and encrypted audit trails.',
  keywords: [
    'healthcare logistics software',
    'pharmacy delivery management',
    'medical courier software',
    'HIPAA logistics',
    'chain of custody tracking',
    'cold chain delivery',
  ],
  openGraph: {
    title: 'Healthcare & Pharmacy Logistics | LogisBase',
    description:
      'Chain-of-custody you can prove. Compliance you can afford. Patients you can trust.',
  },
  twitter: {
    ...
    <SolutionPageLayout
      ...
      title={
        <>
          ...
          <br />
          <span className="text-gradient">Compliance You Can Afford.</span>
        </>
      }
      description="Healthcare and pharmacy logistics demand an audit trail for everything, zero tolerance for delivery failure, and data privacy you can defend in front of any regulator. LogisBase delivers all three — with encrypted chain-of-custody records, priority dispatch for time-sensitive items, and self-hosted deployment that keeps patient data within your own infrastructure."
      stats={[
        { value: '100%', label: 'Chain-of-custody traceability' },
        { value: '99.97%', label: 'On-time delivery rate for urgent items' },
        {
          value: '0',
          label: 'Patient data stored on third-party servers (self-hosted)',
        },
      ...
      heroScreenshotAlt="LogisBase healthcare logistics — chain-of-custody and delivery management"
      painPoints={{
      ...
      features={[
        {
          ...
          description:
            'Every delivery — from collection to final recipient — generates an immutable, timestamped, GPS-anchored chain-of-custody record. Signature capture at each handoff. Photo evidence at every stage. Audit-ready exports on demand.',
          bullets: [
        ...
        },
        {
          ...
          description:
            "When a patient's medication or a lab sample can't wait, LogisBase's priority dispatch engine assigns the nearest available driver immediately — overriding normal queue order and notifying the relevant clinical team in real-time.",
          bullets: [
        ...
        },
        {
          ...
          description:
            "Granular access controls ensure clinical staff, couriers, administrators, and auditors each see only what they're authorised to see. Every access event is logged for compliance reporting.",
          bullets: [
        ...
        },
        {
          ...
          description:
            'For cold-chain pharmaceutical deliveries, LogisBase integrates with IoT temperature sensors to log environmental conditions at each delivery stage. Out-of-range alerts trigger immediate escalation before product is compromised.',
          bullets: [
          ...
          icon: Heart,
          screenshot:
            '/images/screenshots/fleet-ops/fleet-ops-flespi-telematics-integration.webp',
        },
        {
          title: 'Compliance Reporting & Audit Exports',
          description:
            'Generate the compliance reports your regulators require in minutes, not days. All delivery data, access logs, and chain-of-custody records are structured for direct export in the formats required by healthcare regulatory bodies.',
          bullets: [
      ...
      testimonial={{
        quote:
          'The chain-of-custody records alone have saved us from three potential regulatory issues. We can prove exactly where every item was at every moment, and we own the data entirely.',
        author: 'Dr. M. Patel',
      ...
      faqs={[
        ...
        },
        {
          ...
          a: 'LogisBase integrates with IoT temperature monitoring devices via API. Sensor data is appended to each delivery record and out-of-range conditions trigger configurable alerts.',
        },
        {
