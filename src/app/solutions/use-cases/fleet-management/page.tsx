...
export const metadata: Metadata = {
  alternates: {
    canonical: 'https://logisbase.com/solutions/use-cases/fleet-management',
  },
  title: 'Fleet Management Software | LogisBase',
  description:
    'Monitor vehicle health, driver performance, and fleet utilization from one dashboard. Source-accessible fleet management with real-time tracking, maintenance scheduling, and compliance tools.',
  keywords: [
  ...
  openGraph: {
    title: 'Fleet Management Software | LogisBase',
    description:
      'Your entire fleet — every vehicle, every driver, every job — visible and under control.',
  },
  twitter: {
...
export default function FleetManagementPage() {
  return (
    <SolutionPageLayout
      ...
      description="Fleet management without visibility is just expensive guesswork. Breakdowns you didn't see coming. Drivers you can't locate. Compliance documents that are somewhere in a filing cabinet. LogisBase gives you a single operations platform for real-time fleet tracking, preventive maintenance, driver management, and compliance documentation — so nothing slips through the cracks."
      stats={[
      ...
      heroScreenshotAlt="LogisBase fleet management dashboard — real-time vehicle tracking, driver status, and maintenance alerts"
      painPoints={{
      ...
      features={[
        {
          ...
          description:
            "See your entire fleet on a live map at any moment. Track vehicle positions, speed, idling time, and route adherence in real-time. Geofence alerts notify you when vehicles enter or leave defined zones — whether that's a customer site, depot boundary, or restricted area.",
          bullets: [
        ...
        },
        {
          ...
          description:
            'Stop reacting to breakdowns and start preventing them. LogisBase tracks mileage, engine hours, and calendar intervals for each vehicle and automatically schedules the maintenance events that keep your fleet roadworthy — with driver and workshop notifications built in.',
          bullets: [
        ...
        },
        {
          ...
          description:
            'Manage driver profiles, licences, and certifications in one place. Track driver performance metrics — on-time rate, speeding incidents, idle time, and customer ratings — and identify coaching opportunities before small issues become compliance problems.',
          bullets: [
        ...
        },
        {
          ...
          description:
            'Keep your compliance documentation organised and audit-ready. Vehicle inspection records, DVSA compliance forms, driver hour logs, and incident reports are all stored centrally, with automated reminders for upcoming renewals and regulatory submissions.',
          bullets: [
          ...
          icon: FileCheck,
          screenshot:
            '/images/screenshots/fleet-ops/fleet-ops-maintenance-log.webp',
        },
        {
          title: 'Fleet Utilization Analytics',
          description:
            'Understand exactly how your fleet assets are being used. Identify underutilized vehicles that could be redeployed or sold, spot overloaded routes that need additional capacity, and make fleet sizing decisions based on real utilization data rather than gut feel.',
          bullets: [
        ...
        },
        {
          ...
          description:
            "The Navigator app connects drivers to operations. Pre-trip vehicle checks, job assignments, navigation, proof-of-delivery capture, and defect reporting — all in one app on the driver's own smartphone. No dedicated hardware, no manual paperwork.",
          bullets: [
      ...
      testimonial={{
        quote:
          "We went from one unplanned breakdown per fortnight to one every three months. LogisBase's maintenance scheduling caught what our manual system kept missing — and the compliance documentation alone has saved us hours every week.",
        author: 'David M.',
        role: 'Fleet Manager',
      ...
      faqs={[
        {
          q: 'Does LogisBase integrate with vehicle GPS trackers and telematics devices?',
          a: 'Yes. LogisBase integrates with GPS tracking hardware via API, allowing vehicle telemetry data to feed into the live map and analytics dashboards.',
        },
        {
        ...
        },
        {
          ...
          a: 'Driver documents and vehicle compliance records are stored with expiry dates. LogisBase sends automated reminders at configurable intervals before expiry — to the driver, the fleet manager, or both.',
        },
        {
          q: 'Can we manage multiple depots and vehicle types in one account?',
          a: 'Yes. LogisBase supports multi-depot fleet structures with separate vehicle groups, driver pools, and reporting per location — all accessible from one central console.',
        },
        {
          q: 'Is LogisBase suitable for mixed fleets including vans, trucks, and specialist vehicles?',
