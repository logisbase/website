...
export const metadata: Metadata = {
  alternates: {
    canonical: 'https://logisbase.com/solutions/use-cases/integrations',
  },
  ...
  keywords: [
    ...
    'headless logistics platform',
  ],
  openGraph: {
    title: 'Logistics API & Integrations | LogisBase',
    description:
      'A logistics platform that fits your stack — not one that replaces it.',
  },
  twitter: {
    ...
    <SolutionPageLayout
      ...
      title={
        <>
          ...
          <br />
          <span className="text-gradient">Fits Your Stack.</span>
        </>
      }
      description="The best logistics platform is one that works with what you've already built — not one that forces you to rip and replace your existing tools. LogisBase is built API-first from the ground up. Every capability is accessible programmatically. Connect your OMS, WMS, ERP, storefront, or custom systems and build the exact logistics workflow your operation needs — without writing a logistics platform from scratch."
      stats={[
        {
          value: 'API-first',
          label: 'Every feature accessible programmatically',
        },
        { value: '<200ms', label: 'Average API response time' },
        {
          value: 'Real-time',
          label: 'Webhook delivery for every platform event',
        },
        { value: '98%', label: 'API uptime SLA on cloud plans' },
      ]}
      heroScreenshot="/images/screenshots/fleet-ops/fleet-ops-extensions-menu.webp"
      heroScreenshotAlt="LogisBase developer console — API keys, webhooks, and real-time event logs"
      painPoints={{
      ...
      features={[
        {
          title: 'Full REST API',
          description:
            'Every LogisBase capability is accessible via a documented REST API — order creation and management, driver assignment, route management, tracking events, POD retrieval, analytics data, and more. Build exactly the integration your operation requires with a stable, versioned API.',
          bullets: [
        ...
        },
        {
          ...
          description:
            "Don't poll for delivery status — receive it instantly. LogisBase fires webhook events for every meaningful platform event: order created, assigned, picked up, delivered, failed, and dozens more. Configure multiple endpoints, filter by event type, and retry automatically on failure.",
          bullets: [
        ...
        },
        {
          ...
          description:
            'Native connectors for Shopify and WooCommerce push orders into LogisBase at checkout and return delivery events to your storefront — keeping inventory, order status, and customer notifications in sync without custom development.',
          bullets: [
        ...
        },
        {
          ...
          description:
            'Build custom logistics interfaces, customer-facing tracking experiences, or internal tools on top of LogisBase without writing raw HTTP calls. The official JavaScript SDK and React Native bindings give your developers type-safe, well-documented access to the full platform.',
          bullets: [
        ...
        },
        {
          ...
          description:
            "When a pre-built integration doesn't exist, build one. LogisBase's extension system lets your development team build custom modules that run inside the platform — adding new UI panels, API endpoints, background workers, and data models without forking the core.",
          bullets: [
            'Extension scaffold generator for rapid custom module development',
            'Custom API endpoints that run within the LogisBase authentication context',
      ...
      testimonial={{
        quote:
          "We integrated LogisBase with our custom WMS and Shopify store in three days. The API documentation is genuinely complete — we didn't need to reverse engineer anything or raise a support ticket. It just worked.",
        author: 'Thomas R.',
        role: 'Lead Engineer',
      ...
      faqs={[
        {
          q: 'Is there a JavaScript SDK for LogisBase?',
          a: 'Yes. The official LogisBase JS SDK provides a typed, documented interface to the full REST API. React Native bindings are also available for mobile app integration.',
        },
        {
        ...
        },
        {
          ...
          a: 'Yes. LogisBase accounts include a sandbox environment for integration testing with full API and webhook functionality — no production data affected.',
        },
        {
          q: 'Can we build custom UI panels and modules inside the LogisBase console?',
          a: 'Yes. The extension system allows development teams to build custom modules that render UI panels inside the LogisBase console and expose custom API endpoints — all within the existing authentication and permission context.',
        },
      ]}
