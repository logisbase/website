...
export const metadata: Metadata = {
  alternates: {
    canonical: 'https://logisbase.com/solutions/use-cases/order-management',
  },
  ...
  openGraph: {
    title: 'Order Management Software | LogisBase',
    description:
      'Every order type. Every workflow. One platform that bends to your operation.',
  },
  twitter: {
    ...
    <SolutionPageLayout
      ...
      title={
        <>
          One Platform for
          <br />
          <span className="text-gradient">Every Order Type You Run.</span>
        </>
      }
      description="Most order management software was built for one workflow and bolted onto everything else. Your operation is more complex than that — different order types, different SLAs, different proof requirements, different customer expectations. LogisBase gives you a fully configurable order management platform that works the way you work, with custom fields, statuses, workflows, and automation built for real logistics operations."
      stats={[
        { value: '60%', label: 'Reduction in manual order entry errors' },
        { value: '10M+', label: 'Orders processed on LogisBase worldwide' },
        {
          value: '40%',
          label: 'Faster order-to-dispatch time with automation',
        },
      ...
      heroScreenshotAlt="LogisBase order management — order pipeline view with custom statuses and bulk assignment"
      painPoints={{
      ...
      features={[
        {
          ...
          description:
            'Define exactly what an order means in your operation. Custom fields, custom statuses, custom proof requirements, and custom SLA windows — all configurable without code. Run pickup-and-delivery, multi-stop, return orders, and batch orders from the same platform.',
          bullets: [
        ...
        },
        {
          ...
          description:
            'Orders arrive from your OMS, storefront, or API and flow directly into the right dispatch queue — assigned, routed, and ready for driver pickup without manual handling. Configurable routing rules send orders to the right depot, vehicle type, or driver group automatically.',
          bullets: [
        ...
        },
        {
          ...
          description:
            'Every order has a live status visible to your team and — with configurable permissions — to your customers. Track where every order is in its lifecycle, flag at-risk orders before SLA breach, and give customers the visibility they expect without a support call.',
          bullets: [
        ...
        },
        {
          ...
          description:
            'Capture the evidence your operation and your customers need at every completion point. Signatures, photos, QR code scans, and delivery notes — all linked to the order record, timestamped, geotagged, and instantly available for export.',
          bullets: [
          ...
          icon: FileCheck,
          screenshot:
            '/images/screenshots/fleet-ops/fleet-ops-multi-waypoint-order.webp',
        },
        {
          title: 'SLA Management & Breach Prevention',
          description:
            'Define SLA windows per order type, service level, and customer account. LogisBase monitors every active order against its committed window and escalates — automatically — to the right person when an order is at risk, so problems are solved before they become complaints.',
          bullets: [
        ...
        },
        {
          ...
          description:
            'Understand your order operation at the level that matters for your business. Volume by period, SLA performance by customer, on-time rates by order type, and fulfillment cost per order — all from a single analytics dashboard.',
          bullets: [
      ...
      testimonial={{
        quote:
          'We process 2,000 orders per day across four different order types. Before LogisBase, we had a different system for each. Now everything runs in one platform with the custom fields and statuses we actually need. Order entry errors dropped 60% in the first month.',
        author: 'Priya S.',
      ...
      faqs={[
        {
          q: 'Can LogisBase handle multiple order types with different workflows?',
        ...
        {
          q: 'How do orders get into LogisBase from our existing systems?',
