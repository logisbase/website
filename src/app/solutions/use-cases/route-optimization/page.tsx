...
export const metadata: Metadata = {
  alternates: {
    canonical: 'https://logisbase.com/solutions/use-cases/route-optimization',
  },
  title: 'Route Optimization Software | LogisBase',
  description:
    'Cut fuel costs by 28% and improve on-time rates with intelligent multi-stop route optimization. Real-time traffic, time windows, vehicle capacity — all factored in automatically.',
  keywords: [
  ...
  openGraph: {
    title: 'Route Optimization Software | LogisBase',
    description:
      'Stop planning routes by hand. Let LogisBase optimize every run for time, fuel, and capacity.',
  },
  twitter: {
    card: 'summary_large_image',
    title: `Route Optimization Software | LogisBase`,
    description: `Stop planning routes by hand. Let LogisBase optimize every run for time, fuel, and capacity.`,
  },
};
...
export default function RouteOptimizationPage() {
  return (
    <SolutionPageLayout
      ...
      heroScreenshotAlt="LogisBase route optimization — multi-stop route sequencing on live map with efficiency metrics"
      painPoints={{
      ...
      features={[
        {
          ...
          description:
            'LogisBase sequences routes by solving for the full picture simultaneously — delivery time windows, vehicle weight and volume capacity, driver work-hour limits, depot start and end constraints, and customer priority levels. Not one factor at a time. All at once.',
          bullets: [
        ...
        },
        {
          ...
          description:
            "Routes don't survive first contact with the day. When a delivery is added, cancelled, or delayed — or when traffic blocks a critical road — LogisBase recalculates the affected run automatically and pushes the updated route to the driver's Navigator app instantly.",
          bullets: [
          ...
          icon: RefreshCw,
          screenshot:
            '/images/screenshots/fleet-ops/fleet-ops-order-route-editor.webp',
        },
        {
          title: 'Multi-Vehicle Fleet Coordination',
          description:
            'Optimizing one route in isolation creates bottlenecks across your fleet. LogisBase coordinates the entire fleet simultaneously — balancing workload across vehicles, eliminating zone overlap, and ensuring no driver finishes two hours early while another runs overtime.',
          bullets: [
        ...
        },
        {
          ...
          description:
            "Customer-promised delivery windows are constraints, not suggestions. LogisBase builds routes that respect every committed window — and alerts dispatchers before a route is finalized if any window can't be met, so you can fix it before a customer is disappointed.",
          bullets: [
        ...
        },
        {
          ...
          description:
            'Track planned vs. actual route execution to understand where optimization is working and where drivers are deviating. Identify recurring inefficiencies, flag problematic zones, and use real data to continuously improve your planning parameters.',
          bullets: [
        ...
        },
        {
          ...
          description:
            'Feed LogisBase orders from your OMS via API, CSV import, or manual entry. The optimization engine handles fleet routing for any volume — from 10 stops to 10,000 — and presents a complete optimized plan for dispatcher review before dispatch.',
          bullets: [
          ...
          icon: Zap,
          screenshot:
            '/images/screenshots/fleet-ops/fleet-ops-orders-import.webp',
        },
      ]}
      capabilities={[
      ...
      testimonial={{
        quote:
          'We reduced our daily driven distance by 22% in the first two weeks. What used to take our dispatcher 90 minutes every morning now takes 3 minutes. LogisBase paid back its cost in fuel savings alone within the first month.',
        author: 'James K.',
      ...
      faqs={[
        {
          q: 'How fast does LogisBase optimize a route?',
        ...
        },
        {
          ...
          a: "LogisBase re-evaluates the affected route in real-time and updates the driver's Navigator app with the revised stop sequence — including re-optimized ETAs for all remaining stops.",
        },
        {
          q: 'Does LogisBase integrate with our existing OMS for order import?',
          a: 'Yes. The REST API allows orders to flow directly from your OMS into LogisBase for planning and dispatch. Webhooks return delivery events back to your system in real-time.',
        },
        {
