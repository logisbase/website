...
export const metadata: Metadata = {
  alternates: {
    canonical: 'https://logisbase.com/solutions/use-cases/analytics',
  },
  title: 'Logistics Analytics & Reporting | LogisBase',
  description:
    'Turn logistics data into decisions. Live dashboards, KPI tracking, cost analysis, and exportable reports for fleet performance, delivery SLAs, driver metrics, and operational costs.',
  keywords: [
    'logistics analytics software',
    'fleet performance dashboard',
    'delivery KPI tracking',
    'logistics reporting platform',
  ...
  openGraph: {
    title: 'Logistics Analytics & Reporting | LogisBase',
    description:
      'Stop managing your logistics operation by feel. Start managing it by data.',
  },
  twitter: {
  ...
  return (
    <SolutionPageLayout
      ...
      stats={[
        {
          value: '35%',
          label: 'Faster identification of operational cost drivers',
        },
        {
          value: '50%',
          label: 'Reduction in time spent compiling reports manually',
        },
        {
          value: '18%',
          label: 'Improvement in on-time delivery after KPI visibility',
        },
        { value: '10M+', label: 'Orders tracked and analysed on LogisBase' },
      ]}
      heroScreenshot="/images/screenshots/fleet-ops/fleet-ops-report-builder.webp"
      heroScreenshotAlt="LogisBase logistics analytics dashboard — fleet KPIs, delivery performance, and cost breakdown"
      painPoints={{
      ...
      features={[
        {
          ...
          description:
            "The moment you open LogisBase, you see the current state of your operation — active deliveries, at-risk orders, driver status, and today's performance against targets. No lag, no refresh. The data is live because your operation doesn't pause for reports.",
          bullets: [
        ...
        },
        {
          ...
          description:
            'Track the metrics that determine whether your delivery operation is meeting commitments: first-attempt delivery rate, on-time percentage, average delivery duration, and SLA adherence — broken down by zone, customer, driver, and time period.',
          bullets: [
        ...
        },
        {
          ...
          description:
            "Understand exactly what's happening at the vehicle and driver level. Identify your top performers, catch underperformance early, and make data-driven decisions on driver training, route assignments, and fleet expansion.",
          bullets: [
        ...
        },
        {
          ...
          description:
            'Know exactly what every delivery, route, and customer account costs your operation. Track fuel cost per route, cost-per-delivery by zone, and overall margin by service type — so pricing decisions are based on real numbers, not estimates.',
          bullets: [
        ...
        },
        {
          ...
          description:
            'Generate the reports your clients and regulators need — automatically, from your operational data. SLA performance summaries, delivery audit records, compliance certificates, and custom-format reports on a schedule you define.',
          bullets: [
        ...
        },
        {
          ...
          description:
            'Build the dashboards and reports your operation actually needs — not what came preconfigured. Drag-and-drop report builder lets operations managers, finance, and account teams each build views tailored to their role without needing a developer.',
          bullets: [
      ...
      testimonial={{
        quote:
          "We used to spend two days every month pulling together the client SLA report. Now it's generated automatically and in their inbox on the first of the month. And because we can see performance in real time, we fix issues before they show up in the report.",
        author: 'Marcus H.',
      ...
      faqs={[
        ...
        {
          q: 'Does LogisBase track fuel costs and vehicle running costs?',
