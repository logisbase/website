...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'E-commerce & Retail Delivery Software | LogisBase',
    description:
      'Give your customers the delivery experience they expect — and keep the margins that make it worth it.',
  },
  twitter: {
    ...
    <SolutionPageLayout
      ...
      title={
        <>
          Own Your Last Mile.
          <br />
          <span className="text-gradient">Stop Paying Carrier Fees.</span>
        </>
      }
      description="Carrier dependency is costing your e-commerce business more than you think — in fees, in brand experience, and in customer loyalty. LogisBase gives you a complete owned-delivery platform: headless API, real-time customer tracking, same-day dispatch, and returns management — built to plug into your existing stack."
      stats={[
        { value: '2-day', label: 'To same-day delivery capability' },
        {
          value: '45%',
          label: 'Reduction in carrier costs for own-fleet operators',
        },
        {
          value: '3.2×',
      ...
      heroScreenshotAlt="LogisBase e-commerce delivery operations dashboard"
      painPoints={{
      ...
      features={[
        {
          ...
          description:
            "LogisBase's REST API integrates directly into your Shopify, WooCommerce, Magento, or custom storefront. Orders flow from checkout to dispatch automatically — no manual data entry, no middleware hacks.",
          bullets: [
        ...
        },
        {
          ...
          description:
            "Replace the generic carrier tracking page with your own branded experience. Customers see your logo, your colours, and your messaging — while tracking their order's real-time position on a live map.",
          bullets: [
        ...
        },
        {
          ...
          description:
            "Offer same-day delivery as a competitive differentiator, not a logistics headache. LogisBase's automated dispatch assigns orders to the nearest available driver the moment they're ready to ship — with zero manual coordination.",
          bullets: [
        ...
        },
        {
          ...
          description:
            "Proactive delivery communication isn't just good service — it drives repeat purchases. Customers who track a delivery are 3.2× more likely to reorder. Every LogisBase notification is an opportunity to bring them back.",
          bullets: [
        ...
        },
        {
          ...
          description:
            'Returns are the silent margin killer. LogisBase automates reverse dispatch — scheduling pick-ups, tracking inbound returns, and updating your WMS when goods are received — so your team spends zero time on manual returns coordination.',
          bullets: [
        ...
        },
        {
          ...
          description:
            'Connect LogisBase to your warehouse or Pallet inventory module for end-to-end fulfilment visibility. Know when stock is picked, packed, and dispatched — and catch fulfilment bottlenecks before they become delays.',
          bullets: [
      ...
      testimonial={{
        quote:
          "We built our own same-day delivery proposition on LogisBase in three weeks. We've since removed two third-party carriers from our stack and cut delivery costs by 40%.",
        author: 'Sarah L.',
      ...
      faqs={[
        {
          q: 'Does LogisBase work with Shopify, WooCommerce, and other platforms?',
        ...
        },
        {
          ...
          a: 'Yes. LogisBase manages own-fleet dispatch natively and can receive webhook events from carrier tracking systems, giving you a single operations view regardless of delivery method.',
        },
        {
        ...
        {
          q: 'Can LogisBase handle peak sale periods like Black Friday?',
          a: 'Yes. LogisBase scales horizontally. Cloud plans handle spikes automatically. Self-hosted deployments can be right-sized for peak capacity.',
        },
        {
          q: 'Does it support international or cross-border deliveries?',
          a: 'LogisBase supports multi-currency, multi-language, and multi-region configurations. International carrier integration is available via the API.',
        },
      ]}
