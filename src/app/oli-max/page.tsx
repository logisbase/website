...
const stats = [
  ...
  { value: '100%', label: 'Built on LogisBase' },
];
...
const stackParts = [
  ...
  },
  {
    ...
    description:
      "Native QPay integration via the LogisBase payment gateway driver — Mongolia's most-used mobile-first checkout, no Western card friction.",
          ...
          <div className="grid items-center gap-16 lg:grid-cols-[1.2fr_1fr]">
            <div className="flex max-w-2xl flex-col gap-7">
              ...
              <p className="max-w-xl text-lg leading-relaxed text-white/85 md:text-xl">
                ...
                rice, flour, oil, and bulk meat directly from distributors and
                factories — at the best prices in the country. The whole
                operation runs on a forked Storefront app, dispatched through
                FleetOps.
              </p>
              <div className="flex flex-wrap gap-4">
                <Button
                  size="lg"
                  asChild
                  className="bg-[var(--oli-gold)] font-semibold text-[var(--oli-deep)] shadow-lg hover:bg-[var(--oli-gold)]/90"
                >
                  <Link
                    href="https://www.oli.mn"
                    target="_blank"
            ...
            <div className="relative hidden h-[520px] lg:block">
              ...
              <div className="absolute top-12 left-0 -rotate-[8deg]">
                <PhoneFrame
          ...
          <div className="grid items-start gap-16 lg:grid-cols-2">
            <div className="flex flex-col gap-6">
              ...
              <p className="text-lg leading-relaxed text-[var(--oli-fg-muted)]">
                Oli Max is operated by{' '}
                <strong className="text-[var(--oli-fg)]">Techbase LLC</strong>,
                a logistics-and-tech company based in Ulaanbaatar, Mongolia. The
                product simplifies a layer of the local economy that
                historically depended on stacks of resellers between producer
                and customer.
              </p>
              <p className="text-lg leading-relaxed text-[var(--oli-fg-muted)]">
                By holding direct partnerships with distributors and factories,
                Oli Max lets restaurants, market vendors, and households buy
        ...
        <div className="container">
          <div className="mx-auto mb-16 max-w-3xl text-center">
            ...
            <p className="mt-4 text-lg leading-relaxed text-[var(--oli-fg-muted)]">
              From login to reorder, every screen is tuned for the single
              purpose of buying bulk staples — fast.
            </p>
          </div>
          ...
          <div className="grid justify-items-center gap-6 md:grid-cols-3 lg:gap-8">
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="max-w-[240px] text-center">
                <p className="text-base font-semibold">
                  Browse by truck or vendor
                </p>
                <p className="mt-1 text-sm leading-snug text-[var(--oli-fg-muted)]">
                  See every active distributor and food truck near you, with
                  live inventory.
                </p>
              </div>
            </div>
            <div className="flex flex-col items-center gap-4">
              ...
              />
              <div className="max-w-[240px] text-center">
                <p className="text-base font-semibold">Frictionless checkout</p>
                <p className="mt-1 text-sm leading-snug text-[var(--oli-fg-muted)]">
                  Saved addresses, vehicle dispatch options, scheduled or
                  on-demand delivery.
                </p>
              </div>
            </div>
            <div className="flex flex-col items-center gap-4">
              ...
              />
              <div className="max-w-[240px] text-center">
                <p className="text-base font-semibold">Reorder in two taps</p>
                <p className="mt-1 text-sm leading-snug text-[var(--oli-fg-muted)]">
                  Restaurant operators stock the same staples weekly — order
                  history makes reordering trivial.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="grid items-center gap-16 lg:grid-cols-[1fr_1.1fr]">
            ...
            <div className="order-1 flex flex-col gap-6 lg:order-2">
              ...
              <p className="text-lg leading-relaxed text-[var(--oli-fg-muted)]">
                Oli Max pioneered a unique mode in Storefront: each food truck
                is a
                <em className="font-semibold text-[var(--oli-fg)] not-italic">
                  {' '}
                  moving vendor
                </em>{' '}
          ...
          <div className="grid gap-5 md:grid-cols-2">
            {stackParts.map((p) => (
              ...
              >
                ...
                <p className="mb-4 text-sm leading-relaxed text-[var(--oli-fg-muted)]">
                  {p.description}
                </p>
                <Link
                  href={p.docs}
          ...
          <div className="grid grid-cols-2 gap-6 md:grid-cols-4">
            {stats.map((s) => (
              <div key={s.label} className="text-center">
                <div className="text-3xl font-bold text-[var(--oli-gold)] md:text-4xl">
                  {s.value}
                </div>
                <div className="mt-1 text-sm text-[var(--oli-fg-muted)]">
                  {s.label}
                </div>
              </div>
            ))}
        ...
        <div className="container">
          <div className="grid items-center gap-16 lg:grid-cols-[1.2fr_1fr]">
            <div className="flex flex-col gap-6">
              ...
              <p className="text-lg leading-relaxed text-[var(--oli-fg-muted)]">
                We work directly with the Techbase engineering team on roadmap
                items that affect the local logistics market — and they ship our
                changes to thousands of operators across Ulaanbaatar.
              </p>
              <div className="grid grid-cols-2 gap-3 pt-2">
                <div className="rounded-xl border border-[var(--oli-border)] bg-[var(--oli-card)] p-4">
                  <Factory className="mb-2 size-5 text-[var(--oli-orange)]" />
            ...
            <div className="flex flex-col items-center gap-6">
              ...
              />
              <p className="max-w-xs text-center text-sm text-[var(--oli-fg-muted)]">
                Fully white-labelled. App Store-ready. Same Storefront source as
                every other LogisBase deployment.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative overflow-hidden bg-[var(--oli-orange)] py-20 md:py-28">
        <div className="container">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="text-4xl leading-[1.05] font-bold tracking-tight text-balance text-white md:text-5xl">
