  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="section-padding text-center">
        <div className="container mx-auto max-w-4xl">
          ...
          <p className="text-muted-foreground mx-auto mb-10 max-w-2xl text-xl">
            LogisBase Cloud starts at $25/month. No per-seat charges. No hidden
            fees. Self-hosted implementation is a one-time $2,500 fee.
          </p>

          {/* Billing Toggle */}
          <div className="mb-10 flex justify-center">
            <div className="bg-muted/30 inline-flex items-center gap-1 rounded-full border p-1">
              <button
      ...
      <section className="section-padding pt-0">
        <div className="container">
          <div className="mb-10 text-center">
            <h2 className="mb-2 text-3xl font-bold">LogisBase Cloud</h2>
            <p className="text-muted-foreground">
              Fully managed. Automatic updates. Unlimited users and drivers. All
              platform modules included on every plan.
            </p>
          </div>

          {/* Featured Plans */}
          <div className="mx-auto mb-4 grid max-w-5xl grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
            {FEATURED_TIERS.map((tier) => (
              <Card
                ...
                className={cn(
                  ...
                  tier.highlight &&
                    'border-primary shadow-primary/10 pt-0 shadow-lg',
                )}
              >
                {tier.badge && (
          ...
          <div className="mb-4 text-center">
            ...
            >
              {showAllPlans ? (
                <>
                  Hide full plan list <ChevronUp className="h-4 w-4" />
                </>
              ) : (
                <>
                  Compare all 13 plans <ChevronDown className="h-4 w-4" />
                </>
              )}
            </button>
          </div>
                ...
                <tbody>
                  {CLOUD_TIERS.map((tier, i) => (
                    ...
                    >
                      ...
                      <td className="text-muted-foreground hidden px-4 py-3 text-right md:table-cell">
                        ${tier.overage}/unit
                      </td>
                      <td className="px-4 py-3 text-right">
                        <Link
      ...
      <section className="section-padding bg-muted/20">
        <div className="container mx-auto max-w-4xl">
          <div className="mb-10 text-center">
            <h2 className="mb-2 text-2xl font-bold">How Resource Units Work</h2>
            <p className="text-muted-foreground">
              Your plan includes a monthly unit allocation. Each resource type
              consumes a set number of units per item created. Most resources
              reset each billing cycle — rolling resources (marked below) carry
              their count into the next cycle.
            </p>
          </div>
          ...
          <div className="mb-3 grid grid-cols-2 gap-3 md:grid-cols-3 lg:grid-cols-6">
            {RESOURCE_UNITS.map((r) => (
              ...
              >
                <r.icon className="text-primary mx-auto mb-2 h-5 w-5" />
          ...
          <div className="text-muted-foreground mb-8 flex gap-6 text-xs">
          ...
          <div className="bg-card rounded-xl border p-6">
            <div className="mb-4">
              ...
              <p className="text-muted-foreground text-sm">
                Need more mid-month? Purchase a top-up at any time — no plan
                change required.
              </p>
            </div>
      ...
      <section className="section-padding">
        <div className="container">
          <div className="mb-10 text-center">
            ...
            <p className="text-muted-foreground">
              Full control over your infrastructure, or custom-built solutions
      ...
      <section className="section-padding bg-muted/20">
        <div className="container">
          <div className="mb-10 text-center">
            <h2 className="mb-2 text-3xl font-bold">Support Levels</h2>
            <p className="text-muted-foreground mx-auto max-w-2xl">
              Choose the level of ongoing support that matches your team&apos;s
              capacity and ambition. Available for both Cloud and Self-Hosted
              customers.
            </p>
          </div>
              ...
              >
                <CardHeader className="pb-3">
                  <div className="mb-1 flex items-center gap-2">
                    <div
                      className={cn('h-3 w-3 rounded-full', tier.colorClass)}
                    />
                    <CardTitle className="text-base">{tier.name}</CardTitle>
                  </div>
                ...
                <CardContent className="flex-1 space-y-2">
                  {tier.features.map((f) => (
                    ...
                    >
                      ...
                      <span
                        className={f.included ? '' : 'text-muted-foreground/50'}
                      >
                        {f.label}
                      </span>
                    </div>
          ...
          <div className="bg-card relative overflow-hidden rounded-2xl border p-12 text-center">
            ...
            <div className="relative">
              ...
              <p className="text-muted-foreground mb-8">
                Try LogisBase free for 7 days or 50 resource units, whichever
                comes first. Or speak to our team to find the right plan for
                your operation.
              </p>
              <div className="flex flex-wrap justify-center gap-4">
                <Button size="lg" asChild>
