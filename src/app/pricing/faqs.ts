export const PRICING_FAQS = [
  ...
  },
  {
    ...
    answer:
      'LogisBase Cloud is fully managed by us — we handle infrastructure, security patches, and uptime. Self-Hosted means you deploy LogisBase on your own servers or cloud account. The one-time $2,500 implementation fee covers deployment, CI/CD setup, configuration, and branding.',
  },
  {
    question: 'Do I need a Commercial License?',
    answer:
      'Only if you plan to build proprietary (closed-source) extensions or integrations on top of LogisBase. The core platform is Source-accessible-licensed, which requires open-sourcing modifications. A Commercial License waives this obligation and keeps your custom code private. See /licensing/commercial for full details, pricing tiers, and the FAQ.',
  },
  {
