...
const integrationSteps = [
  {
    ...
    description:
      'An order arrives via Storefront or API. Pallet receives it and generates a pick list automatically.',
  },
  {
    icon: ClipboardList,
    color: 'text-amber-500',
    ...
    description:
      'Warehouse staff work through the pick list, confirm each item, and pack the order. Status updates in real time.',
  },
  {
    icon: Truck,
    color: 'text-blue-500',
    ...
    description:
      'Once packed, Fleet-Ops receives the fulfilment trigger and assigns a driver. No manual handoff required.',
  },
  {
    icon: MapPin,
    ...
    description:
      'Driver navigates to the customer, captures proof of delivery, and the order is marked complete across all modules.',
  },
];
...
const useCases = [
  {
    ...
    description:
      'High-volume order picking connected directly to Storefront and Fleet-Ops dispatch — no manual handoffs between systems.',
  },
  {
    icon: Users,
    color: 'text-violet-500',
    ...
    description:
      'Multi-client inventory management with separate stock, reporting, and billing per client — all in one warehouse.',
  },
  {
    icon: ShoppingBag,
    color: 'text-amber-500',
    ...
    description:
      'Multi-store inventory allocation, stock transfers between locations, and replenishment workflows.',
  },
  {
    icon: Globe,
    color: 'text-emerald-500',
    ...
    title: 'Food & Beverage',
    description:
      'Stock level tracking, expiry-aware fulfillment, and warehouse-to-delivery in one connected platform.',
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    a: 'Pallet and Fleet-Ops are native LogisBase modules sharing the same data layer. When an order is fulfilled in Pallet, Fleet-Ops receives the dispatch trigger automatically — no webhook, no middleware, no manual step. You get full end-to-end visibility from inbound stock to proof of delivery.',
  },
  {
    ...
    <div className="flex flex-col">
      ...
      <section className="section-padding relative overflow-hidden">
        ...
        <div className="container space-y-12">
          ...
          {/* Hero screenshot */}
          <BrowserFrame
            label="LogisBase — Operations Dashboard"
            className="shadow-2xl"
          >
            <div className="relative aspect-[16/7] w-full">
              <Image
                src="/images/screenshots/fleet-ops/fleet-ops-orders-kanban.webp"
                alt="LogisBase platform showing order and inventory management across warehouse and delivery operations"
                fill
          ...
          <div className="grid gap-12 lg:grid-cols-5 lg:gap-16">
            <div className="flex flex-col justify-center gap-5 lg:col-span-2">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Most warehouses run on software that has no idea what happens
                after a pallet leaves the dock. Pallet closes that gap —
                natively, not through an integration.
              </p>
            </div>
        ...
        <div className="container space-y-10">
          <div className="mx-auto max-w-3xl space-y-4 text-center">
            ...
            <p className="text-muted-foreground text-lg leading-snug lg:text-xl">
              From inbound stock to outbound dispatch — Pallet covers the core
              warehouse workflows your team runs every day, connected to the
              rest of your LogisBase operation.
            </p>
          </div>

          <div
            className="bg-border grid grid-cols-1 overflow-hidden rounded-xl border sm:grid-cols-2 lg:grid-cols-3"
            style={{ gap: '1px' }}
          >
      ...
      <section className="section-padding">
        <div className="container space-y-12">
          <div className="mx-auto max-w-3xl space-y-4 text-center">
            ...
            <p className="text-muted-foreground text-lg leading-snug lg:text-xl">
              Pallet sits between your commerce layer and your delivery layer.
              Orders from Storefront become pick lists in Pallet, and fulfilled
              orders trigger dispatch in Fleet-Ops — automatically, with no
              manual handoffs.
            </p>
          </div>
        ...
        <div className="container space-y-10">
          <div className="mx-auto max-w-3xl space-y-4 text-center">
            ...
            <p className="text-muted-foreground text-lg leading-snug">
              Whether you run a single fulfilment centre or a multi-location 3PL
              network, Pallet gives you the warehouse layer your operation is
              missing.
            </p>
          </div>
          <div
          ...
          <div className="mx-auto max-w-3xl">
            <div className="mb-12 space-y-4 text-center">
              ...
              <p className="text-muted-foreground">
                Everything you need to know about Pallet.
              </p>
            </div>
