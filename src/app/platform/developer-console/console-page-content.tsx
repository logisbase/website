...
curl -X POST https://api.logisbase.com/v1/orders \\
        ...
        <div className="relative container">
          <div className="mx-auto flex max-w-4xl flex-col items-center gap-8 text-center">
            ...
            <p className="text-foreground/90 dark:text-foreground/95 max-w-3xl leading-snug md:text-lg">
              The LogisBase Developer Console gives you everything you need to
              integrate, debug, and monitor your logistics platform. Manage API
              keys, configure webhooks, inspect request logs, and watch
              real-time socket channels — all from one place.
            </p>
            ...
            <div className="relative mt-4 aspect-video w-full overflow-hidden rounded-xl border shadow-2xl">
              <Image
                ...
                alt="LogisBase Developer Console — API request log with method, status, and latency"
                fill
        ...
        <div className="container">
          <div className="mb-12 text-center">
            ...
            <p className="text-muted-foreground mx-auto max-w-2xl">
              Six core tools that make integrating with LogisBase fast,
              reliable, and fully transparent.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: 'Generate, name, and manage multiple API keys per organisation. Set expiry dates, rotate keys, and revoke access instantly.',
                href: '/docs/platform/developer-console/api-keys',
              },
              {
                icon: Webhook,
                title: 'Webhook Configuration',
                desc: 'Subscribe to platform events and deliver real-time HTTP notifications to any endpoint. Configure retries and view delivery history.',
                href: '/docs/platform/developer-console/webhooks',
              },
              {
                icon: Activity,
                title: 'Request Logs',
                desc: 'Full audit trail of every API request — method, endpoint, payload, response, latency, status code, and authenticating key.',
                href: '/docs/platform/developer-console/request-logs',
              },
              {
                icon: Wifi,
                title: 'Socket Channels',
                desc: 'Monitor active SocketCluster channels, connected clients, and real-time message streams for live data integrations.',
                href: '/docs/platform/developer-console/socket-events',
              },
              {
                icon: Radio,
                title: 'Event Stream',
                desc: 'Browse all platform events in chronological order. Filter by type, entity, or time range to debug integration issues.',
                href: '/docs/platform/developer-console/system-events',
              },
              {
                icon: Shield,
                title: 'Sandbox Mode',
                desc: 'Test your integration against a fully isolated sandbox without affecting production data or triggering live webhooks.',
                href: '/docs/platform/developer-console',
              },
            ].map(({ icon: Icon, title, desc, href }) => (
              <Link
                key={title}
                href={href}
                className="group bg-background hover:bg-muted/30 flex flex-col gap-3 p-6 transition-colors"
              >
          ...
          <div className="grid items-center gap-16 lg:grid-cols-2">
            <div className="flex flex-col gap-6">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Generate multiple API keys for different environments and
                services. Every key is scoped to your organisation, can be named
                for easy identification, and can be revoked instantly if
                compromised. Set expiry dates to enforce rotation policies
                across your team.
              </p>
            ...
            <div className="relative aspect-[4/3] overflow-hidden rounded-xl border shadow-lg">
              <Image
                ...
                alt="LogisBase Developer Console — API key management"
                fill
                className="object-cover object-top"
        ...
        <div className="container">
          <div className="grid items-center gap-16 lg:grid-cols-2">
            ...
            <div className="order-1 flex flex-col gap-6 lg:order-2">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Configure webhooks to push event notifications to your systems
                the moment something happens in LogisBase. Subscribe to specific
                event types or receive all events. Every delivery is logged with
                the full request and response so you can debug failures
                instantly.
              </p>
              <div className="grid grid-cols-2 gap-3">
                {[
                  {
                    label: 'Order Events',
                    examples: 'created, dispatched, completed, cancelled',
                  },
                  {
                    label: 'Driver Events',
                    examples: 'assigned, location updated, status changed',
                  },
                  {
                    label: 'Payment Events',
                    examples: 'invoice created, payment received, payout sent',
                  },
                  {
                    label: 'Entity Events',
                    examples: 'contact, place, vehicle, fleet updates',
                  },
                ].map(({ label, examples }) => (
        ...
        <div className="container">
          <div className="grid items-center gap-16 lg:grid-cols-2">
            <div className="flex flex-col gap-6">
              ...
              <p className="text-muted-foreground leading-relaxed">
                The request log gives you a full audit trail of every API call
                made to your LogisBase instance — request method, endpoint,
                payload, response body, HTTP status, latency, and which API key
                was used, all in real time.
              </p>
              <ul className="space-y-5">
                {[
                  {
                    icon: Search,
                    title: 'Full request & response',
                    desc: 'Inspect the complete payload and response body for every API call, including headers and query parameters.',
                  },
                  {
                    icon: Clock,
                    title: 'Latency tracking',
                    desc: 'Monitor response times across all endpoints to spot performance bottlenecks before they affect users.',
                  },
                  {
                    icon: XCircle,
                    title: 'Error highlighting',
                    desc: '4xx and 5xx responses are flagged for quick identification. Drill into any failure to see the exact error returned.',
                  },
                  {
                    icon: Filter,
                    title: 'Filter & search',
                    desc: 'Filter by endpoint, HTTP method, status code, API key, or time range to find the request you need immediately.',
                  },
            ...
            <div className="relative aspect-[4/3] overflow-hidden rounded-xl border shadow-lg">
              <Image
                ...
                alt="LogisBase Developer Console — request log entry details with payload and response"
                fill
                className="object-cover object-top"
                sizes="(max-width: 768px) 100vw, 50vw"
              />
        ...
        <div className="container">
          <div className="grid items-center gap-16 lg:grid-cols-2">
            ...
            <div className="order-1 flex flex-col gap-6 lg:order-2">
              ...
              <p className="text-muted-foreground leading-relaxed">
                LogisBase uses SocketCluster to deliver real-time updates to
                connected clients. The Developer Console gives you full
                visibility into active channels, connected clients, and message
                throughput so you can monitor and debug live data streams. Use
                the official{' '}
        ...
        <div className="container">
          <div className="mb-12 text-center">
            <div className="mb-4 inline-flex items-center rounded-full border px-3 py-1 text-xs">
              <Terminal className="text-primary mr-2 h-3 w-3" />
              Quick Start
            </div>
            <h2 className="mb-4 text-4xl font-bold tracking-tight">
            ...
            <p className="text-muted-foreground mx-auto max-w-2xl">
              Generate an API key from the Developer Console and make your first
              request in seconds. Subscribe to live events using the official
              SocketCluster client.
            </p>
          </div>
        ...
        <div className="container">
          <div className="mx-auto max-w-3xl">
            ...
            <Accordion type="single" collapsible className="space-y-3">
              {[
                {
                  q: 'What is the LogisBase Developer Console?',
                  a: 'The Developer Console is a dedicated extension within the LogisBase platform that gives developers full control over API keys, webhooks, event logs, socket channels, and real-time activity monitoring. It is the central hub for integrating external systems with LogisBase.',
                },
                {
                  q: 'How do API keys work in LogisBase?',
                ...
                },
                {
                  ...
                  a: 'LogisBase emits webhook events for all major platform actions including order lifecycle events (created, dispatched, completed, cancelled), driver status changes, entity updates, payment events, and custom extension events. You can subscribe to specific events or receive all events.',
                },
                {
                ...
                },
                {
                  ...
                  a: 'Socket Channels are real-time WebSocket channels powered by SocketCluster. They allow your application to receive live updates from LogisBase without polling. Connect using the official socketcluster-client npm package. The console shows all active channels, connected clients, and recent messages.',
                },
                {
          ...
          <div className="bg-card relative overflow-hidden rounded-2xl border px-8 py-16 text-center">
            ...
            <div className="relative flex flex-col items-center gap-6">
              ...
              <p className="text-muted-foreground max-w-xl">
                Open the Developer Console, generate your first API key, and
                start integrating LogisBase into your systems today.
              </p>
